...
@Repository
public interface GSTDDM_DDM_GST_4A_Dao {
	...
	public List<SP_DDM_GST_4A_COMM_TEMP_Result> generateResultBeanList_SP_DDM_GST_4A_COMM_TEMP(String mM_YYYY,
			String code, Object crr, HttpServletRequest request);

	public String generateResult__GSTDDM_DDM_GST_4A_INSERT(String p_COMM_CODE, String p_MM_YYYY, String p_SERVICE_NAME,
