...
@Repository
public interface GSTDDM_DDM_GST_5_Dao {

	public List<SP_DDM_GST_5_ALL_Result> generateResultBeanList_SP_DDM_GST_5_ALL(String _MM_YYYY);

	// public List<SP_DDM_GST_5_REGION_Result>
	// generateResultBeanList_SP_DDM_GST_5_REGION(String code, String _MM_YYYY);
