...
public class SP_DDM_GST_3_COMM_TEMP_Result {
	...
	public List<SP_DDM_GST_3_COMM_TEMP_Result> generateResultBeanList(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DDM_GST_3_COMM_TEMP_Result> list = new ArrayList<SP_DDM_GST_3_COMM_TEMP_Result>();
			for (Object[] objectArray : resultList) {
				SP_DDM_GST_3_COMM_TEMP_Result temp = new SP_DDM_GST_3_COMM_TEMP_Result();
	...
	public SP_DDM_GST_3_COMM_TEMP_Result generateResultBean(Object[] objectArray) {
		SP_DDM_GST_3_COMM_TEMP_Result temp = new SP_DDM_GST_3_COMM_TEMP_Result();
