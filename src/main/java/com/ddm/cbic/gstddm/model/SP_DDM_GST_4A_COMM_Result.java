...
public class SP_DDM_GST_4A_COMM_Result {
	...
	public List<SP_DDM_GST_4A_COMM_Result> generateResultBeanList(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DDM_GST_4A_COMM_Result> list = new ArrayList<SP_DDM_GST_4A_COMM_Result>();
			for (Object[] objectArray : resultList) {
				SP_DDM_GST_4A_COMM_Result temp = new SP_DDM_GST_4A_COMM_Result();
	...
	public SP_DDM_GST_4A_COMM_Result generateResultBean(Object[] objectArray) {
		SP_DDM_GST_4A_COMM_Result temp = new SP_DDM_GST_4A_COMM_Result();
		 ...
		 * temp.setREASONS(String.valueOf(objectArray[11]));
		 */
