...
public class SP_DDM_GST_4A_COMM_TEMP_REPORT_Result {
	...
	public List<SP_DDM_GST_4A_COMM_TEMP_REPORT_Result> generateResultBeanList(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DDM_GST_4A_COMM_TEMP_REPORT_Result> list = new ArrayList<SP_DDM_GST_4A_COMM_TEMP_REPORT_Result>();
			for (Object[] objectArray : resultList) {
				SP_DDM_GST_4A_COMM_TEMP_REPORT_Result temp = new SP_DDM_GST_4A_COMM_TEMP_REPORT_Result();
	...
	public SP_DDM_GST_4A_COMM_TEMP_REPORT_Result generateResultBean(Object[] objectArray) {
		SP_DDM_GST_4A_COMM_TEMP_REPORT_Result temp = new SP_DDM_GST_4A_COMM_TEMP_REPORT_Result();
...
//		temp.setMM_YYYY(String.valueOf(objectArray[4]));
		...
		/*23-MAY-23
		 * temp.setSERVICE_CODE(String.valueOf(objectArray[0]));
		 * temp.setSERVICE_NAME(String.valueOf(objectArray[1]));
		 * temp.setCUR_YEAR_FOR(String.valueOf(objectArray[2]));
		 * temp.setCUR_YEAR_UPTO(String.valueOf(objectArray[3]));
		 * temp.setPRE_YEAR_FOR(String.valueOf(objectArray[4]));
		 * temp.setPRE_YEAR_UPTO(String.valueOf(objectArray[5]));
		 * temp.setREASONS(String.valueOf(objectArray[6]));
		 */		
