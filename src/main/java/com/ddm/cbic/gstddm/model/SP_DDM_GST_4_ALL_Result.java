...
public class SP_DDM_GST_4_ALL_Result {
	...
	/*
	 * public String getSNO() { return SNO; } public void setSNO(String sNO) { SNO =
	 * sNO; }
	 */
	...
	public List<SP_DDM_GST_4_ALL_Result> generateResultBeanList(List<Object[]> resultList) {
	...
	public SP_DDM_GST_4_ALL_Result generateResultBean(Object[] objectArray) {
		SP_DDM_GST_4_ALL_Result temp = new SP_DDM_GST_4_ALL_Result();
		...
		//temp.setSNO(String.valueOf(objectArray[5]));
