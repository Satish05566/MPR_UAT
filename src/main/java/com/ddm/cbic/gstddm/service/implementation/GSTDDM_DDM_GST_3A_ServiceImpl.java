...
import com.ddm.cbic.gstddm.controller.GSTDDM_DDM_GST_3A_controller;
import com.ddm.cbic.gstddm.dao.implementation.GSTDDM_DDM_GST_3A_DaoImpl;
...
import com.ddm.cbic.gstddm.service.GSTDDM_DDM_GST_3A_Service;

@Service
public class GSTDDM_DDM_GST_3A_ServiceImpl implements GSTDDM_DDM_GST_3A_Service {

	private static final Logger logger = LoggerFactory.getLogger(GSTDDM_DDM_GST_3A_controller.class);

	@Autowired
	GSTDDM_DDM_GST_3A_DaoImpl gstddm_DDM_GST__3A_DaoImpl;
	...
	public ModelAndView getReport_DDM_GST_3A(String Report_Type, String Code, String Report_Name, String MM_YYYY,
		...
		if (request.getSession().getAttribute("CSRF_Token").toString().equalsIgnoreCase(request_CSRF_Token)) {
			...
			List<SP_DDM_GST_3A_ALL_Result> all_report = new ArrayList<SP_DDM_GST_3A_ALL_Result>();
			List<SP_DDM_GST_3A_ZONE_Result> zone_report = new ArrayList<SP_DDM_GST_3A_ZONE_Result>();
			//List<SP_GST_REV_3_REGION_Result> region_report = new ArrayList<SP_GST_REV_3_REGION_Result>();
			List<SP_DDM_GST_3A_COMM_Result> comm_report = new ArrayList<SP_DDM_GST_3A_COMM_Result>();
			List<SP_DDM_GST_3A_COMM_TEMP_REPORT_Result> temp_report = new ArrayList<SP_DDM_GST_3A_COMM_TEMP_REPORT_Result>();

			System.out.println("in GST_REV_3A action _MM_YYYY--" + _MM_YYYY);
			...
			case "All": {
				...
				all_report = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_ALL(_MM_YYYY);
			...
			case "Zone": {
				...
				zone_report = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_ZONE(Code, _MM_YYYY);
				if (zone_report != null) {
			...
			case "Comm": {
				...
				comm_report = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_COMM(Code, _MM_YYYY);
				if (comm_report != null) {
			...
			case "Temp": {
				...
				objArray1[0] = Code;
				Object month = gstddm_DDM_GST__3A_DaoImpl.generateResult_SP_DDM_GST_3A_MAX_DATE(Code);
				...
				temp_report = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_COMM_TEMP_REPORT(objArray);
				if (temp_report != null) {
			...
			case "Crr": {
				...
				temp_report = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_COMM_TEMP_REPORT(objArray1);
			...
			modelView.setViewName("GSTDDM/Report/DDM-GST-3A");
	...
	public ModelAndView get_DDM_GST_3A(Model model, HttpServletRequest request, String request_CSRF_Token) {
		...
		List<SP_DDM_GST_3A_COMM_TEMP_Result> commTempResult = new ArrayList<SP_DDM_GST_3A_COMM_TEMP_Result>();
		commTempResult = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_COMM_TEMP(MM_YYYY, code, crr,
				request);
		...
		modelView.addObject("gstRev3ACommTemp", new SP_DDM_GST_3A_COMM_TEMP_Result());
		modelView.setViewName("GSTDDM/Insert/DDM-GST-3A");
		return modelView;
	}

	@Override
	public ModelAndView post_DDM_GST_3A(SP_DDM_GST_3A_COMM_TEMP_Result gstRev3ACommTemp, BindingResult reslt, Model model,
		...
		if (HDTokenNo.equals(request.getSession().getAttribute("TokenNo"))) {
			...
			if (btn_submit.equals("Update") && !(crr == "" || crr == null) && (!reslt.hasErrors())) {
				...
				result = gstddm_DDM_GST__3A_DaoImpl.generateResult_SP_DDM_GST_3A_TEMP_UPDATE(code, MM_YYYY,
						gstRev3ACommTemp.getSR_NO(), gstRev3ACommTemp.getGSTIN(), gstRev3ACommTemp.getNAME_OF_TAXPAYER(),
						gstRev3ACommTemp.getCASH_FOR_CURRENT(), gstRev3ACommTemp.getITC_FOR_CURRENT(), gstRev3ACommTemp.getCASH_UPTO_CURRENT(),
						gstRev3ACommTemp.getITC_UPTO_CURRENT(), gstRev3ACommTemp.getCASH_FOR_PREV(), gstRev3ACommTemp.getITC_FOR_PREV(),
						gstRev3ACommTemp.getCASH_UPTO_PREV(), gstRev3ACommTemp.getITC_UPTO_PREV(), gstRev3ACommTemp.getREASON_FOR_INCREASE_REVENUE(),
						"T");
				...
				modelView.addObject("CRR", "");
				result = gstddm_DDM_GST__3A_DaoImpl.generateResult_SP_DDM_GST_3A_INSERT(code, MM_YYYY,
						gstRev3ACommTemp.getSR_NO(), gstRev3ACommTemp.getGSTIN(), gstRev3ACommTemp.getNAME_OF_TAXPAYER(),
						gstRev3ACommTemp.getCASH_FOR_CURRENT(), gstRev3ACommTemp.getITC_FOR_CURRENT(), gstRev3ACommTemp.getCASH_UPTO_CURRENT(),
						gstRev3ACommTemp.getITC_UPTO_CURRENT(), gstRev3ACommTemp.getCASH_FOR_PREV(), gstRev3ACommTemp.getITC_FOR_PREV(),
						gstRev3ACommTemp.getCASH_UPTO_PREV(), gstRev3ACommTemp.getITC_UPTO_PREV(), gstRev3ACommTemp.getREASON_FOR_INCREASE_REVENUE(),null);
				...
				commTempResult = gstddm_DDM_GST__3A_DaoImpl.generateResultBeanList_SP_DDM_GST_3A_COMM_TEMP(MM_YYYY, code, crr,request);
