...
import com.ddm.cbic.gstddm.dao.implementation.GSTDDM_DDM_GST_4_DaoImpl;
...
import com.ddm.cbic.gstddm.service.GSTDDM_DDM_GST_4_Service;

@Service
public class GSTDDM_DDM_GST_4_ServiceImpl implements GSTDDM_DDM_GST_4_Service {

	private static final Logger logger = LoggerFactory.getLogger(GSTDDM_DDM_GST_4_ServiceImpl.class);

	@Autowired
	GSTDDM_DDM_GST_4_DaoImpl gstddm_ddm_gst__4_daoImpl;
	...
	public ModelAndView getReport_DDM_GST_4(String Report_Type, String Code, String Report_Name, String MM_YYYY,
		...
		if (request.getSession().getAttribute("CSRF_Token").toString().equalsIgnoreCase(request_CSRF_Token)) {
			...
			List<SP_DDM_GST_4_ALL_Result> all_report = new ArrayList<SP_DDM_GST_4_ALL_Result>();
			List<SP_DDM_GST_4_ZONE_Result> zone_report = new ArrayList<SP_DDM_GST_4_ZONE_Result>();
			List<SP_DDM_GST_4_COMM_Result> comm_report = new ArrayList<SP_DDM_GST_4_COMM_Result>();
			List<SP_DDM_GST_4_COMM_TEMP_REPORT_Result> temp_report = new ArrayList<SP_DDM_GST_4_COMM_TEMP_REPORT_Result>();

			System.out.println("in DDM_GST_4 action _MM_YYYY--" + _MM_YYYY);
			...
			case "All": {
				...
				all_report = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_ALL(_MM_YYYY);
			...
			case "Zone": {
				...
				zone_report = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_ZONE(Code, _MM_YYYY);
				if (zone_report != null) {
			...
			case "Comm": {
				...
				comm_report = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_COMM(Code, _MM_YYYY);
				if (comm_report != null) {
			...
			case "Temp": {
				...
				objArray1[0] = Code;
				Object month = gstddm_ddm_gst__4_daoImpl.generateResult_SP_DDM_GST_4_MAX_DATE(Code);
				...
				temp_report = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_COMM_TEMP_REPORT(objArray);
				if (temp_report != null) {
			...
			case "Crr": {
				...
				temp_report = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_COMM_TEMP_REPORT(objArray1);
			...
			ModelView.setViewName("GSTDDM/Report/DDM-GST-4");
	...
	public ModelAndView get_DDM_GST_4(Model Model, HttpServletRequest request, String request_CSRF_Token) {
		...
		List<SP_DDM_GST_4_COMM_TEMP_Result> commTempResult = new ArrayList<SP_DDM_GST_4_COMM_TEMP_Result>();
		commTempResult = gstddm_ddm_gst__4_daoImpl.generateResultBeanList_SP_DDM_GST_4_COMM_TEMP(code, MM_YYYY, crr,
				request);
		...
		ModelView.addObject("DdmGst4CommTemp", new SP_DDM_GST_4_COMM_TEMP_Result());
		ModelView.setViewName("GSTDDM/Insert/DDM-GST-4");
		return ModelView;
	}
	...
	public ModelAndView post_DDM_GST_4(SP_DDM_GST_4_COMM_TEMP_Result DdmGst4CommTemp, BindingResult reslt, Model Model,
		...
		if (HDTokenNo.equals(request.getSession().getAttribute("TokenNo"))) {
			...
			if (btn_submit.equals("Update") && !(crr == "" || crr == null) && (!reslt.hasErrors())) {
				...
				result = gstddm_ddm_gst__4_daoImpl.generateResult_SP_DDM_GST_4_TEMP_UPDATE(code, MM_YYYY,
						request.getParameter("SNO"), request.getParameter("HSN_CODE"),
						request.getParameter("DESC_OF_GOODS"), request.getParameter("CUR_YEAR_FOR"),
						request.getParameter("txt_CUR_YEAR_UPTO"), request.getParameter("PRE_YEAR_FOR"),
				...
				ModelView.addObject("CRR", "");
				result = gstddm_ddm_gst__4_daoImpl.generateResult_SP_DDM_GST_4_INSERT(code, MM_YYYY,
						request.getParameter("DESC_OF_GOODS"),
