...
public interface GSTDPM_DPM_GST_4_Dao {
	public List<SP_DPM_GST_4_ALL_Result> generateResult_SP_DPM_GST_4_ALL(String mm_yyyy);
	public List<SP_DPM_GST_4_ZONE_Result> generateResult_SP_DPM_GST_4_ZONE(String zone,
			String mm_yyyy);
	public List<SP_DPM_GST_4_COMM_Result> generateResult_SP_DPM_GST_4_COMM(String zone,
			String mm_yyyy);
	...
	public List<SP_DPM_GST_4_COMM_TEMP_REPORT_Result> generateResultBeanList_SP_DPM_GST_4_COMM_TEMP_REPORT(Object[] objArray) ;
