...
@Repository
public class GSTDPM_DPM_GST_15C_Dao_Impl implements GSTDPM_DPM_GST_15C_Dao{
	...
	public Object generateResult_SP_DPM_GST_15C_MAX_DATE(String code) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_MAX_DATE");
	...
	public SP_DPM_GST_15C_COMM_TEMP_Result generateResult_SP_DPM_GST_15C_COMM_TEMP(String code, String mm_yyyy, Object crr,
		...
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_COMM_TEMP");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		...
		return new SP_DPM_GST_15C_COMM_TEMP_Result().generateCommTempResult(query.getResultList());
	...
	public String generateResult_SP_DPM_GST_15C_UPDATE(String code, String mm_yyyy, String PERSONAL_HEARING_GRANTED_NO_GSTIN,
		...
		if(crr ==null || crr =="")crr = null;
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_UPDATE");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, code);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, mm_yyyy);
		query.registerStoredProcedureParameter(3, String.class, ParameterMode.IN);
		query.setParameter(3, PERSONAL_HEARING_GRANTED_NO_GSTIN);
		query.registerStoredProcedureParameter(4, String.class, ParameterMode.IN);
		query.setParameter(4, NOTIME_LEFT_FOR_REJECTION_NO_GSTIN);
		...
		query.setParameter(7, OTHERS_SPECIFY);
	...
	public String generateResult_SP_DPM_GST_15C_INSERT(String code, String mm_yyyy, String PERSONAL_HEARING_GRANTED_NO_GSTIN,
		...
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_INSERT");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, code);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, mm_yyyy);
	...
	public SP_DPM_GST_15C_ALL_Result generateResult_SP_DPM_GST_15C_ALL(String mm_yyyy) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_ALL");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, mm_yyyy);							
		query.execute();				
		return new SP_DPM_GST_15C_ALL_Result().generateAllResult(query.getResultList());
	}

	@Override
	public SP_DPM_GST_15C_REGION_Result generateResult_SP_DPM_GST_15C_REGION(String code, String mm_yyyy) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_REGION");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, code);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, mm_yyyy);						
		query.execute();				
		 return new SP_DPM_GST_15C_REGION_Result().generateRegionResult(query.getResultList());

	}

	@Override
	public SP_DPM_GST_15C_ZONE_Result generateResult_SP_DPM_GST_15C_ZONE(String code, String mm_yyyy) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_ZONE");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, mm_yyyy);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, code);						
		query.execute();				
		return new SP_DPM_GST_15C_ZONE_Result().generateZoneResult(query.getResultList());		
	}

	@Override
	public SP_DPM_GST_15C_COMM_Result generateResult_SP_DPM_GST_15C_COMM(String code, String mm_yyyy) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_COMM");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, mm_yyyy);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, code);		
		query.execute();				
		return new SP_DPM_GST_15C_COMM_Result().generateCommResult(query.getResultList());
	...
	public SP_DPM_GST_15C_COMM_TEMP_REPORT_Result generateResult_SP_DPM_GST_15C_COMM_TEMP_REPORT(String code,
		...
		if(crr == null || crr == "")crr=null;
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_15C_COMM_TEMP_REPORT");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, mm_yyyy);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, code);
		...
		return new SP_DPM_GST_15C_COMM_TEMP_REPORT_Result().generateTempResult(query.getResultList());
