...
@Repository
public class GSTDPM_DPM_GST_4_DaoImpl implements  GSTDPM_DPM_GST_4_Dao{
	
	@Autowired
	private EntityManager entityManager;
	StoredProcedureQuery query;
	@SuppressWarnings("unchecked")
	public List<SP_DPM_GST_4_ALL_Result> generateResult_SP_DPM_GST_4_ALL(String mm_yyyy) {
		// TODO Auto-generated method stub
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_4_ALL");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, mm_yyyy);
		query.execute();				
		return new SP_DPM_GST_4_ALL_Result().generateAllResult(query.getResultList());
	}
	
	public List<SP_DPM_GST_4_ZONE_Result> generateResult_SP_DPM_GST_4_ZONE(String zone ,String mm_yyyy) {
		// TODO Auto-generated method stub
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_4_ZONE");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(1, zone);			
		query.setParameter(2, mm_yyyy);							
		query.execute();				
		return new SP_DPM_GST_4_ZONE_Result().generateAllResult(query.getResultList());
	}
	public List<SP_DPM_GST_4_COMM_Result> generateResult_SP_DPM_GST_4_COMM(String comm ,String mm_yyyy) {
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_4_COMM");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(1, comm);			
		query.setParameter(2, mm_yyyy);								
		query.execute();				
		return new SP_DPM_GST_4_COMM_Result().generateAllResult(query.getResultList());
	}
	
	public Object generateResult_SP_DPM_GST_4_MAX_DATE(String comm) {
		query = entityManager.createStoredProcedureQuery("SP_DPM_GST_4_MAX_DATE");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, comm);
		query.execute();
		return query.getResultList().get(0);
	}
	public List<SP_DPM_GST_4_COMM_TEMP_REPORT_Result> 
	generateResultBeanList_SP_DPM_GST_4_COMM_TEMP_REPORT(
			Object[] objArray) {
		query = entityManager.createStoredProcedureQuery("SP_DPM_GST_4_COMM_TEMP_REPORT");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		if (null != objArray[0]) {
		...
		return new SP_DPM_GST_4_COMM_TEMP_REPORT_Result().generateAllResult(query.getResultList());
	}
	
	// -------------------------------------------------------------------------------
	public List<SP_DPM_GST_4_COMM_TEMP_Result> generateResultBeanList_SP_DPM_GST_4_COMM_TEMP(String mM_YYYY,
			String code, Object crr, HttpServletRequest request) {
		
		query = entityManager.createStoredProcedureQuery("SP_DPM_GST_4_COMM_TEMP");
		if (crr == null || crr == "")
			crr = null;
		...
		return new SP_DPM_GST_4_COMM_TEMP_Result().generateAllResult(query.getResultList());
	}

	//---------------------------------
	public String generateResult_SP_DPM_GST_4_TEMP_UPDATE(String p_COMM_CODE, String p_MM_YYYY, 
			...
			String p_CRR) {
		query = entityManager.createStoredProcedureQuery("SP_DPM_GST_4_UPDATE");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
	...
	public String generateResult_SP_DPM_GST_4_INSERT(String p_COMM_CODE, String p_MM_YYYY, 
			String p_SR_NO, String p_REFUND_CATEGORY, String p_OPENING_BALANCE_NO,
			String p_OPENING_BALANCE_AMOUNT, String p_RFD_01_NO, String p_RFD_01_AMOUNT,
			String p_RFD_02_NO,String p_RFD_03_NO,
			String p_RFD_03_AMOUNT, String p_RFD_04_NO,String p_RFD_04_AMOUNT,String p_RFD_06_SANCTIONED_NO,
		...
		query = entityManager.createStoredProcedureQuery("SP_DPM_GST_4_INSERT");
		query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
		query.setParameter(1, p_COMM_CODE);
		query.registerStoredProcedureParameter(2, String.class, ParameterMode.IN);
		query.setParameter(2, p_MM_YYYY);
	...
	public List<SP_DPM_GST_4_REFUND_CATEGORY> generateResultBeanSP_DPM_GST_4_REFUND_LIST(){
		query= entityManager.createStoredProcedureQuery("SP_DPM_GST_4_REFUND_CATEGORY");
		query.execute();				
		return new SP_DPM_GST_4_REFUND_CATEGORY().generateAllResult(query.getResultList());
	}
