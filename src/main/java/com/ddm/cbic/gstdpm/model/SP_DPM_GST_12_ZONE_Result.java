...
public class SP_DPM_GST_12_ZONE_Result {
	...
	public List<SP_DPM_GST_12_ZONE_Result>  generateAllResult(List <Object []> resultList) {
		if(resultList.size()==0)
			  return null;
		else {
		List <SP_DPM_GST_12_ZONE_Result> list =  new ArrayList<SP_DPM_GST_12_ZONE_Result>();
		for(Object [] objectArray : resultList) { 
			SP_DPM_GST_12_ZONE_Result temp = new SP_DPM_GST_12_ZONE_Result ();
	 ...
	 private SP_DPM_GST_12_ZONE_Result generateReportBean(Object[] objectArray) {
