...
public class SP_DPM_GST_14A_ALL_Result {
	...
	public SP_DPM_GST_14A_ALL_Result generateAllResult(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DPM_GST_14A_ALL_Result> list = new ArrayList<SP_DPM_GST_14A_ALL_Result>();
			for (Object[] objectArray : resultList) {
				SP_DPM_GST_14A_ALL_Result temp = new SP_DPM_GST_14A_ALL_Result();
	...
	private SP_DPM_GST_14A_ALL_Result generateReportBean(Object[] objectArray) {
		...
		if (null != objectArray[3]) {
			temp.setOPENING_BALANCE(String.valueOf(objectArray[3]));
		}
		if (null != objectArray[4]) {
			temp.setNO_OF_ARN_RECEIVED_GSTN(String.valueOf(objectArray[4]));
		}
		if (null != objectArray[5]) {
			temp.setNO_OF_ARN_RECEIVED_CPC(String.valueOf(objectArray[5]));
		}
		if (null != objectArray[6]) {
			temp.setDISPOSAL_OF_ARN_WITHIN_7(String.valueOf(objectArray[6]));
		}
		if (null != objectArray[7]) {
			temp.setDISPOSAL_OF_ARN_PV_RECOMMENDED(String.valueOf(objectArray[7]));
		}
		if (null != objectArray[8]) {
			temp.setDISPOSAL_OF_ARN_PV_APPROVED(String.valueOf(objectArray[8]));
		}
		if (null != objectArray[9]) {
			temp.setDISPOSAL_OF_ARN_PV_REJECTED(String.valueOf(objectArray[9]));
		}
		if (null != objectArray[10]) {
			temp.setDISPOSAL_OF_ARN_PV_NOT_RECEIVED(String.valueOf(objectArray[10]));
		}
		if (null != objectArray[11]) {
			temp.setDISPOSAL_OF_ARN_TRANSFERED_CPC(String.valueOf(objectArray[11]));
		}
		if (null != objectArray[12]) {
			temp.setDISPOSAL_OF_ARN_DEEMED_REG(String.valueOf(objectArray[12]));
		}

		if (null != objectArray[13]) {
			temp.setTOTAL_ARN_APPROVED(String.valueOf(objectArray[13]));
		}
		if (null != objectArray[14]) {
			temp.setTOTAL_ARN_REJECTED(String.valueOf(objectArray[14]));
		}
		if (null != objectArray[15]) {
			temp.setTOTAL_ARN_DISPOSED(String.valueOf(objectArray[15]));
		}

		if (null != objectArray[16]) {
			temp.setCLOSING_BALANCE(String.valueOf(objectArray[16]));
		}
