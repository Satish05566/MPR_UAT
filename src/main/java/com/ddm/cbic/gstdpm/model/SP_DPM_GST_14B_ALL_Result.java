...
public class SP_DPM_GST_14B_ALL_Result {
	...
	public SP_DPM_GST_14B_ALL_Result generateAllResult(List <Object []> resultList) {
		if(resultList.size()==0 )
			  return null;
		else {
		List <SP_DPM_GST_14B_ALL_Result> list =  new ArrayList<SP_DPM_GST_14B_ALL_Result>();
		for(Object [] objectArray : resultList) { 
			SP_DPM_GST_14B_ALL_Result temp = new SP_DPM_GST_14B_ALL_Result ();
	 ...
	 private SP_DPM_GST_14B_ALL_Result generateReportBean(Object[] objectArray) {
			...
			if(null != objectArray[3]){temp.setRECEIVED_FROM_OTHER_CPC(String.valueOf(objectArray[3]));}
			if(null != objectArray[4]){temp.setPV_REPORT_NOT_RECEIVED(String.valueOf(objectArray[4]));}
			if(null != objectArray[5]){temp.setOFFICER_FAILED_TO_PROCESS_ARN(String.valueOf(objectArray[5]));}
			if(null != objectArray[6]){temp.setOTHERS(String.valueOf(objectArray[6]));}
			if(null != objectArray[7]){temp.setTOTAL(String.valueOf(objectArray[7]));}
