...
public class SP_DPM_GST_15B_ALL_Result {
	...
	public SP_DPM_GST_15B_ALL_Result generateAllResult(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DPM_GST_15B_ALL_Result> list = new ArrayList<SP_DPM_GST_15B_ALL_Result>();
			for (Object[] objectArray : resultList) {
				SP_DPM_GST_15B_ALL_Result temp = new SP_DPM_GST_15B_ALL_Result();
	...
	private SP_DPM_GST_15B_ALL_Result generateReportBean(Object[] objectArray) {
		...
		if (null != objectArray[3]) {
			temp.setPENDENCY_PART_OFFICER_NO_GSTIN(String.valueOf(objectArray[3]));
		}
		if (null != objectArray[4]) {
			temp.setREPLY_AWAITED_TAXPAYER_NO_GSTIN(String.valueOf(objectArray[4]));
		}
