...
public class SP_DPM_GST_15C_COMM_TEMP_REPORT_Result {
	...
	public SP_DPM_GST_15C_COMM_TEMP_REPORT_Result generateTempResult(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_DPM_GST_15C_COMM_TEMP_REPORT_Result> list = new ArrayList<SP_DPM_GST_15C_COMM_TEMP_REPORT_Result>();
			for (Object[] objectArray : resultList) {
				SP_DPM_GST_15C_COMM_TEMP_REPORT_Result temp = new SP_DPM_GST_15C_COMM_TEMP_REPORT_Result();
	...
	private SP_DPM_GST_15C_COMM_TEMP_REPORT_Result generateReportBean(Object[] objectArray) {
		...
		if (null != objectArray[4]) {
			temp.setPERSONAL_HEARING_GRANTED_NO_GSTIN(String.valueOf(objectArray[4]));
		}
		if (null != objectArray[5]) {
			temp.setNOTIME_LEFT_FOR_REJECTION_NO_GSTIN(String.valueOf(objectArray[5]));
		}
		if (null != objectArray[6]) {
			temp.setTAXES_OR_DUES_UNPAID_NO_GSTIN(String.valueOf(objectArray[6]));
		}
		if (null != objectArray[7]) {
			temp.setTECHNICAL_ISSUES_NO_GSTIN(String.valueOf(objectArray[7]));
		}
		if (null != objectArray[8]) {
			temp.setOTHERS_SPECIFY(String.valueOf(objectArray[8]));
		}
		if (null != objectArray[9]) {
			temp.setOTHERS_NO_GSTIN(String.valueOf(objectArray[9]));
		}
