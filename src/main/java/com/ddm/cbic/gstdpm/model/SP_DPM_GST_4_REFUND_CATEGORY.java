...
public class SP_DPM_GST_4_REFUND_CATEGORY {
	...
	public List<SP_DPM_GST_4_REFUND_CATEGORY>  generateAllResult(List <Object []> resultList) {
		if(resultList.size()==0)
			  return null;
		else {
		List <SP_DPM_GST_4_REFUND_CATEGORY> list =  new ArrayList<SP_DPM_GST_4_REFUND_CATEGORY>();
		for(Object [] objectArray : resultList) { 
			SP_DPM_GST_4_REFUND_CATEGORY temp = new SP_DPM_GST_4_REFUND_CATEGORY ();
	 ...
	 private SP_DPM_GST_4_REFUND_CATEGORY generateReportBean(Object[] objectArray) {
