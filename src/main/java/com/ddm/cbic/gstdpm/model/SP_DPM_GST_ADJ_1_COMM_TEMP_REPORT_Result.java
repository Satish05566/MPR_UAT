...
public class SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result {
	...
	public SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result  generateAllResult(List <Object []> resultList) {
		if(resultList.size()==0)
			  return null;
		else {
		List <SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result> list =  new ArrayList<SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result>();
		//for(Object [] objectArray : resultList) { 
			SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result temp = new SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result ();
	 ...
	 private SP_DPM_GST_ADJ_1_COMM_TEMP_REPORT_Result generateReportBean(Object[] objectArray) {
			...
			if (null != objectArray[267]){ temp.setCOMM_CODE(String.valueOf(objectArray[267]));}
