...
public class SP_DPM_GST_ADJ_2_ALL_Result {
	...
	public List<SP_DPM_GST_ADJ_2_ALL_Result>  generateAllResult(List <Object []> resultList) {
		if(resultList.size()==0)
			  return null;
		else {
		List <SP_DPM_GST_ADJ_2_ALL_Result> list =  new ArrayList<SP_DPM_GST_ADJ_2_ALL_Result>();
		for(Object [] objectArray : resultList) { 
			SP_DPM_GST_ADJ_2_ALL_Result temp = new SP_DPM_GST_ADJ_2_ALL_Result ();
	 ...
	 private SP_DPM_GST_ADJ_2_ALL_Result generateReportBean(Object[] objectArray) {

			SP_DPM_GST_ADJ_2_ALL_Result temp =  new SP_DPM_GST_ADJ_2_ALL_Result();
			
			if(null != objectArray[0]) {temp.setAMND(String.valueOf(objectArray[0]));}
			if(null != objectArray[1]){temp.setTOTAL_COMM(String.valueOf(objectArray[1]).strip());}
			if(null != objectArray[2]) {temp.setCOMPLETE_COMM(String.valueOf(objectArray[2]).strip());}
