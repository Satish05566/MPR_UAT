...
public class SP_DPM_GST_ADJ_2_OPENING_Result {
	...
	public  List<SP_DPM_GST_ADJ_2_OPENING_Result> generateResultBeanList(List<Object []> listObjectArray) {
		List <SP_DPM_GST_ADJ_2_OPENING_Result> list =  new ArrayList<SP_DPM_GST_ADJ_2_OPENING_Result>();
		for(Object [] objArray : listObjectArray) { 
			SP_DPM_GST_ADJ_2_OPENING_Result temp = new SP_DPM_GST_ADJ_2_OPENING_Result ();
	...
	public  SP_DPM_GST_ADJ_2_OPENING_Result generateResultBean(Object [] objectArray) {
		SP_DPM_GST_ADJ_2_OPENING_Result temp =  new SP_DPM_GST_ADJ_2_OPENING_Result();
