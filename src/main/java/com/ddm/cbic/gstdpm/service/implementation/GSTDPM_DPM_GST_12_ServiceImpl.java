...
@Service
public class GSTDPM_DPM_GST_12_ServiceImpl implements GSTDPM_DPM_GST_12_Service {

	@Autowired
	GSTDPM_DPM_GST_12_Dao gstdpm_DPM_GST_12_Dao;
	...
	public ModelAndView gstReport_DPM_GST_12(String Report_Type, String code, 
		...
		if (request.getSession().getAttribute("CSRF_Token").toString().
			...
			List<SP_DPM_GST_12_ALL_Result> all_report = new ArrayList<SP_DPM_GST_12_ALL_Result>();
			List<SP_DPM_GST_12_ZONE_Result> zone_report = new ArrayList<SP_DPM_GST_12_ZONE_Result>();
			List<SP_DPM_GST_12_COMM_Result> comm_report = new ArrayList<SP_DPM_GST_12_COMM_Result>();
			
			List<SP_DPM_GST_12_COMM_TEMP_REPORT_Result> temp_report = new ArrayList<SP_DPM_GST_12_COMM_TEMP_REPORT_Result>();
			...
			case "All": {
				...
				all_report =  (List<SP_DPM_GST_12_ALL_Result>) gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_ALL(_mm_yyyy);
			...
			case "Zone": {
				...
				zone_report = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_ZONE(code, _mm_yyyy);
				if (zone_report != null) {
			...
			case "Comm": {				
				...
				comm_report = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_COMM(code,_mm_yyyy);				
				if (comm_report != null) {
			  ...
			  Object[] objArray1 = new Object[1]; objArray1[0] = code; Object month =
					  gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_MAX_DATE(code);
			...
			/*  p_COMM_CODE varchar(2),
			  ...
			  temp_report = gstdpm_DPM_GST_12_Dao.generateResultBeanList_SP_DPM_GST_12_COMM_TEMP_REPORT(objArray); 
			  if (temp_report != null) {
			 ...
			 temp_report =gstdpm_DPM_GST_12_Dao.generateResultBeanList_SP_DPM_GST_12_COMM_TEMP_REPORT(objArray1);
		 ...
		 */
			...
			modelView.setViewName("GSTDPM/Report/DPM-GST-12");//DPM-GST-12
			//gstDPM  GSTDPM_GST 
	...
	public ModelAndView get_DPM_GST_12(Model model, HttpServletRequest request, String request_CSRF_Token) {
		...
		if (!(crr == null || crr == "") && !(MM_YYYY == null || MM_YYYY == "")) {
			...
			Object month = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_MAX_DATE(code);
			if (month == null) {
				MM_YYYY = "2022-04-01";
			} else {
		...
		List<SP_DPM_GST_12_COMM_TEMP_Result> commTempResult = new ArrayList<SP_DPM_GST_12_COMM_TEMP_Result>();
		commTempResult = gstdpm_DPM_GST_12_Dao.generateResultBeanList_SP_DPM_GST_12_COMM_TEMP(MM_YYYY, code, crr,
				request);
		...
		modelView.addObject("DpmGst12CommTemp", new SP_DPM_GST_12_COMM_TEMP_Result());
		modelView.setViewName("GSTDPM/Insert/DPM-GST-12");
		return modelView;
	}

	@Override
	public ModelAndView post_DPM_GST_12(SP_DPM_GST_12_COMM_TEMP_Result dpmGst12CommTemp, BindingResult reslt,
		...
		if (HDTokenNo.equals(request.getSession().getAttribute("TokenNo"))) {
			...
			if (btn_submit.equals("Update") && !(crr == "" || crr == null)) {
				...
				result = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_TEMP_UPDATE(code, MM_YYYY,
						dpmGst12CommTemp.getSR_NO(), dpmGst12CommTemp.getNO_TAXPAYER_FOR_MONTH(),
						dpmGst12CommTemp.getNEW_TAXPAYER_FOR_MONTH(), dpmGst12CommTemp.getMIGRATION_TAXPAYER_FROM(),
						dpmGst12CommTemp.getMIGRATION_TAXPAYER_TO(), dpmGst12CommTemp.getSUO_MOTO(),
						dpmGst12CommTemp.getON_REQUEST(), dpmGst12CommTemp.getREVOCATION(), "T");
				...
				result = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_TEMP_UPDATE(code, MM_YYYY,
						...
						dpmGst12CommTemp.getNEW_TAXPAYER_FOR_MONTH(), dpmGst12CommTemp.getMIGRATION_TAXPAYER_FROM(),
						dpmGst12CommTemp.getMIGRATION_TAXPAYER_TO(), dpmGst12CommTemp.getSUO_MOTO(),
						dpmGst12CommTemp.getON_REQUEST(), dpmGst12CommTemp.getREVOCATION(), null);
				...
				modelView.addObject("CRR", "");
				result = gstdpm_DPM_GST_12_Dao.generateResult_SP_DPM_GST_12_INSERT(code, MM_YYYY,
						dpmGst12CommTemp.getSR_NO(), dpmGst12CommTemp.getNO_TAXPAYER_FOR_MONTH(),
						dpmGst12CommTemp.getNEW_TAXPAYER_FOR_MONTH(), dpmGst12CommTemp.getMIGRATION_TAXPAYER_FROM(),
						dpmGst12CommTemp.getMIGRATION_TAXPAYER_TO(), dpmGst12CommTemp.getSUO_MOTO(),
						dpmGst12CommTemp.getON_REQUEST(), dpmGst12CommTemp.getREVOCATION(), null);
