...
@Service
public class GSTDPM_DPM_GST_15B_Service_Impl implements GSTDPM_DPM_GST_15B_Service {
	...
	public ModelAndView get_DPM_GST_15B(HttpServletRequest request) {
		...
		if (!(crr == null || crr == "") && !(mm_yyyy == null || mm_yyyy == "")) {
			...
			Object month = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_MAX_DATE(code);
			if (month == null || month == "") {
				mm_yyyy = "2022-04-01";
			} else {
		...
		SP_DPM_GST_15B_COMM_TEMP_Result tempResult = new SP_DPM_GST_15B_COMM_TEMP_Result();
		tempResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM_TEMP(code, mm_yyyy, crr, request);
		...
		modelView.addObject("dpmGst15bCommTemp", new SP_DPM_GST_15B_COMM_TEMP_Result());
		modelView.setViewName("GSTDPM/Insert/DPM-GST-15B");
		return modelView;

	}

	public ModelAndView post_DPM_GST_15B(
			@ModelAttribute("dpmGst15BCommTemp") SP_DPM_GST_15B_COMM_TEMP_Result dpmGst15BCommTemp, BindingResult reslt,
		...
		if (btn_submit.equals("Update")  && (!reslt.hasErrors())) {
			modelView.addObject("CRR", "");
			result = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_UPDATE(code, mm_yyyy,
					dpmGst15BCommTemp.getPENDENCY_PART_OFFICER_NO_GSTIN(),
					dpmGst15BCommTemp.getREPLY_AWAITED_TAXPAYER_NO_GSTIN(),
					dpmGst15BCommTemp.getTAXES_OR_DUES_UNPAID_NO_GSTIN(),
					dpmGst15BCommTemp.getTECHNICAL_ISSUES_NO_GSTIN(),
					dpmGst15BCommTemp.getOTHERS_REMARKS(),
					dpmGst15BCommTemp.getOTHERS_NO_GSTIN(), 
					crr);
			modelView.addObject("ViewBagMessage", result);
			modelView.addObject("ViewBag_button", "Update");
		} else if (btn_submit.equals("Upload")  && (!reslt.hasErrors())) {
			modelView.addObject("CRR", "");
			result = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_INSERT(code, mm_yyyy,
					dpmGst15BCommTemp.getPENDENCY_PART_OFFICER_NO_GSTIN(),
					dpmGst15BCommTemp.getREPLY_AWAITED_TAXPAYER_NO_GSTIN(),
					dpmGst15BCommTemp.getTAXES_OR_DUES_UNPAID_NO_GSTIN(),
					dpmGst15BCommTemp.getTECHNICAL_ISSUES_NO_GSTIN(),
	...
	public ModelAndView gstReport_DPM_GST_15B(String report_type, String code, String report_name,
		...
		SP_DPM_GST_15B_ALL_Result allResult = new SP_DPM_GST_15B_ALL_Result();
		SP_DPM_GST_15B_REGION_Result regionResult = new SP_DPM_GST_15B_REGION_Result();
		SP_DPM_GST_15B_ZONE_Result zoneResult = new SP_DPM_GST_15B_ZONE_Result();
		SP_DPM_GST_15B_COMM_Result commResult = new SP_DPM_GST_15B_COMM_Result();
		SP_DPM_GST_15B_COMM_TEMP_REPORT_Result tempResult = new SP_DPM_GST_15B_COMM_TEMP_REPORT_Result();

		switch (report_type) {
		case "All": {
			modelView.addObject("ViewBag_MM_YYYY", mm_yyyy);
			modelView.addObject("ViewBag_Report_Name", report_name);
			allResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_ALL(mm_yyyy);
		...
		case "Region": {
			...
			regionResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_REGION(code, mm_yyyy);
		...
		case "Zone": {
			...
			zoneResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_ZONE(code, mm_yyyy);
		...
		case "Comm": {
			...
			commResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM(code, mm_yyyy);
		...
		case "Temp": {
			...
			modelView.addObject("ViewBag_MM_YYYY", mm_yyyy);
			modelView.addObject("ViewBag_Report_Name", "COMMISSIONERATE : " + report_name);
			tempResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM_TEMP_REPORT(code, mm_yyyy, null, null,
					null);
			modelView.addObject("model", tempResult);
		...
		case "Crr": {
			...
			tempResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM_TEMP_REPORT(code, mm_yyyy, "T", null, null);
			commResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM(code, mm_yyyy);
			modelView.addObject("model", tempResult);
		...
		case "Bak": {
			...
			tempResult = dpm_gst_15B_dao.generateResult_SP_DPM_GST_15B_COMM_TEMP_REPORT(code, mm_yyyy, null, "T",
					Submission_Date);
			modelView.addObject("model", tempResult);
		...
		modelView.setViewName("GSTDPM/Report/DPM-GST-15B");
		return modelView;
	}
