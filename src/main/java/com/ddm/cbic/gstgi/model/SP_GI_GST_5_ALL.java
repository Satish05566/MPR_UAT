...
public class SP_GI_GST_5_ALL {
	...
	public List<SP_GI_GST_5_ALL> generateResultBeanList(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_GI_GST_5_ALL> list = new ArrayList<SP_GI_GST_5_ALL>();
			for (Object[] objectArray : resultList) {
				SP_GI_GST_5_ALL temp = new SP_GI_GST_5_ALL();
	...
	public SP_GI_GST_5_ALL generateResultBean(Object[] objectArray) {
		SP_GI_GST_5_ALL temp = new SP_GI_GST_5_ALL();
