...
public class SP_GI_GST_5_ZONE_Result {
	...
	public List<SP_GI_GST_5_ZONE_Result> generateResultBeanList(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_GI_GST_5_ZONE_Result> list = new ArrayList<SP_GI_GST_5_ZONE_Result>();
			for (Object[] objectArray : resultList) {
				SP_GI_GST_5_ZONE_Result temp = new SP_GI_GST_5_ZONE_Result();
	...
	public SP_GI_GST_5_ZONE_Result generateResultBean(Object[] objectArray) {
		SP_GI_GST_5_ZONE_Result temp = new SP_GI_GST_5_ZONE_Result();
		...
		temp.setAADHAR(String.valueOf(objectArray[3]));
