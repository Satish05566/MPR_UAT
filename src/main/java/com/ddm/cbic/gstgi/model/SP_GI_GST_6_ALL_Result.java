...
public class SP_GI_GST_6_ALL_Result {
...
public void setAMOUNT_OF_TAX_EVASION_PRE_UPTO(String aMOUNT_OF_TAX_EVASION_PRE_UPTO) {
	...
	public List<SP_GI_GST_6_ALL_Result> generateAllResult(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_GI_GST_6_ALL_Result> list = new ArrayList<SP_GI_GST_6_ALL_Result>();
			for (Object[] objectArray : resultList) {
				SP_GI_GST_6_ALL_Result temp = new SP_GI_GST_6_ALL_Result();
	...
	private SP_GI_GST_6_ALL_Result generateReportBean(Object[] objectArray) {
		...
		if (null != objectArray[3])   {temp.setHSN_SAC_CODE(String.valueOf(objectArray[3]));} 
		if (null != objectArray[4])   {temp.setHSN_SAC_CODE_DESCRIPTION(String.valueOf(objectArray[4]));} 
		if (null != objectArray[5])   {temp.setGOODS_OR_SERVICES_TYPE(String.valueOf(objectArray[5]));} 
		if (null != objectArray[6]) {temp.setNO_OF_CASES_CUR_FOR(String.valueOf(objectArray[6]));} 
		if (null != objectArray[7]) {temp.setTAX_EVASION_AMT_CUR_FOR(String.valueOf(objectArray[7]));} 
		if (null != objectArray[8]) {temp.setNO_OF_CASES_CUR_UPTO(String.valueOf(objectArray[8]));} 
		if (null != objectArray[9]) {temp.setAMOUNT_OF_TAX_EVASION_CUR_UPTO(String.valueOf(objectArray[9]));} 
		if (null != objectArray[10]) {temp.setNO_OF_CASES_PRE_FOR(String.valueOf(objectArray[10]));} 
		if (null != objectArray[11]) {temp.setTAX_EVASION_AMT_PRE_FOR(String.valueOf(objectArray[11]));} 
		if (null != objectArray[12]) {temp.setNO_OF_CASES_PRE_UPTO(String.valueOf(objectArray[12]));} 
		if (null != objectArray[13]) {temp.setAMOUNT_OF_TAX_EVASION_PRE_UPTO(String.valueOf(objectArray[13]));}
