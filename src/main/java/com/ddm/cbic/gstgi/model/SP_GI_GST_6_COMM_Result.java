...
public class SP_GI_GST_6_COMM_Result {
	...
	public List<SP_GI_GST_6_COMM_Result> generateCommResult(List <Object []> resultList) {
		if(resultList.size()==0 )
			  return null;
		else {
		List <SP_GI_GST_6_COMM_Result> list =  new ArrayList<SP_GI_GST_6_COMM_Result>();
		for(Object [] objectArray : resultList) { 
			SP_GI_GST_6_COMM_Result temp = new SP_GI_GST_6_COMM_Result ();
	 ...
	 private SP_GI_GST_6_COMM_Result generateReportBean(Object[] objectArray) {
