...
public class SP_GI_GST_6_COMM_TEMP_REPORT_Result {
	...
	public List<SP_GI_GST_6_COMM_TEMP_REPORT_Result> generateTempResult(List<Object[]> resultList) {
		if (resultList.size() == 0)
			return null;
		else {
			List<SP_GI_GST_6_COMM_TEMP_REPORT_Result> list = new ArrayList<SP_GI_GST_6_COMM_TEMP_REPORT_Result>();
			for (Object[] objectArray : resultList) {
				SP_GI_GST_6_COMM_TEMP_REPORT_Result temp = new SP_GI_GST_6_COMM_TEMP_REPORT_Result();
	...
	private SP_GI_GST_6_COMM_TEMP_REPORT_Result generateReportBean(Object[] objectArray) {

		SP_GI_GST_6_COMM_TEMP_REPORT_Result temp = new SP_GI_GST_6_COMM_TEMP_REPORT_Result();

		if (null != objectArray[0])   {temp.setAMND((String) objectArray[0]);}
		...
		if (null != objectArray[3]) {temp.setCOMM_CODE((String)objectArray[3]);}
