...
public class SP_DDM_CE_1_ALL_Result {
	 public int AMND ;
	...
	public List<SP_DDM_CE_1_ALL_Result> sp_DDM_CE_1_ALL_Result(List<Object[]> listObjectArray){
		List <SP_DDM_CE_1_ALL_Result> list = new ArrayList<SP_DDM_CE_1_ALL_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_CE_1_ALL_Result temp = new SP_DDM_CE_1_ALL_Result();
		temp = generateResultBean_SP_DDM_CE_1_ALL(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_CE_1_ALL_Result generateResultBean_SP_DDM_CE_1_ALL(Object[] objectArray)
		{
			SP_DDM_CE_1_ALL_Result temp = new SP_DDM_CE_1_ALL_Result();
			...
			temp.setREBATE_CEX((BigDecimal)( objectArray[9]));}
			if(null!=objectArray[10] && objectArray[10]!=null) {
			temp.setTOTAL_FY((BigDecimal)( objectArray[10]));}
			if(null!=objectArray[11] && objectArray[11]!=null) {
			temp.setTOTAL_TARGET_UPTO((BigDecimal)( objectArray[11]));}
			if(null!=objectArray[12] && objectArray[12]!=null) {
			temp.setTOTAL_TARGET_FOR((BigDecimal)( objectArray[12]));}
			...
			temp.setREBATE_CEX_FOR_C((BigDecimal)( objectArray[18]));}
			if(null!=objectArray[19] && objectArray[19]!=null) {
			temp.setREBATE_FOR_C((BigDecimal)( objectArray[19]));}
			if(null!=objectArray[20] && objectArray[20]!=null) {
			temp.setTOTAL_FOR_C((BigDecimal)( objectArray[20]));}
			if(null!=objectArray[21] && objectArray[21]!=null) {
			temp.setPOL_CRUDE_FOR_P((BigDecimal)( objectArray[21]));}
			if(null!=objectArray[22] && objectArray[22]!=null) {
			temp.setPOL_OTHER_FOR_P((BigDecimal)( objectArray[22]));}
			if(null!=objectArray[23] && objectArray[23]!=null) {
			temp.setNON_POL_FOR_P((BigDecimal)( objectArray[23]));}
			if(null!=objectArray[24] && objectArray[24]!=null) {
			temp.setTOTAL_GROSS_FOR_P((BigDecimal)( objectArray[24]));}
			if(null!=objectArray[25] && objectArray[25]!=null) {
			temp.setREFUND_FOR_P((BigDecimal)( objectArray[25]));}
			if(null!=objectArray[26] && objectArray[26]!=null) {
			temp.setREBATE_FOR_P((BigDecimal)( objectArray[26]));}
			if(null!=objectArray[27] && objectArray[27]!=null) {
			temp.setREBATE_CEX_FOR_P((BigDecimal)( objectArray[27]));}
			if(null!=objectArray[28] && objectArray[28]!=null) {
			temp.setTOTAL_FOR_P((BigDecimal)( objectArray[28]));}
			if(null!=objectArray[29] && objectArray[29]!=null) {
			temp.setPOL_CRUDE_UPTO_C((BigDecimal)( objectArray[29]));}
			if(null!=objectArray[30] && objectArray[30]!=null) {
			temp.setPOL_OTHER_UPTO_C((BigDecimal)( objectArray[30]));}
			if(null!=objectArray[31] && objectArray[31]!=null) {
			temp.setNON_POL_UPTO_C((BigDecimal)( objectArray[31]));}
			if(null!=objectArray[32] && objectArray[32]!=null) {
			temp.setTOTAL_GROSS_UPTO_C((BigDecimal)( objectArray[32]));}
			if(null!=objectArray[33] && objectArray[33]!=null) {
			temp.setREFUND_UPTO_C((BigDecimal)( objectArray[33]));}
			if(null!=objectArray[34] && objectArray[34]!=null) {
			temp.setREBATE_UPTO_C((BigDecimal)( objectArray[34]));}
			if(null!=objectArray[35] && objectArray[35]!=null) {
			temp.setREBATE_CEX_UPTO_C((BigDecimal)( objectArray[35]));}
			if(null!=objectArray[36] && objectArray[36]!=null) {
			temp.setTOTAL_UPTO_C((BigDecimal)( objectArray[36]));}
			if(null!=objectArray[37] && objectArray[37]!=null) {
			temp.setPOL_CRUDE_UPTO_P((BigDecimal)( objectArray[37]));}
			if(null!=objectArray[38] && objectArray[38]!=null) {
			temp.setPOL_OTHER_UPTO_P((BigDecimal)( objectArray[38]));}
			if(null!=objectArray[39] && objectArray[39]!=null) {
			temp.setNON_POL_UPTO_P((BigDecimal)( objectArray[39]));}
			if(null!=objectArray[40] && objectArray[40]!=null) {
			temp.setTOTAL_GROSS_UPTO_P((BigDecimal)( objectArray[40]));}
			if(null!=objectArray[41] && objectArray[41]!=null) {
			temp.setREFUND_UPTO_P((BigDecimal)( objectArray[41]));}
			if(null!=objectArray[42] && objectArray[42]!=null) {
			temp.setREBATE_UPTO_P((BigDecimal)( objectArray[42]));}
			if(null!=objectArray[43] && objectArray[43]!=null) {
			temp.setREBATE_CEX_UPTO_P((BigDecimal)( objectArray[43]));}
			
			
			
			if(null!=objectArray[44] && objectArray[44]!=null) {
			temp.setTOTAL_UPTO_P((BigDecimal)( objectArray[44]));}
			if(null!=objectArray[45] && objectArray[45]!=null) {
			temp.setACTUAL_POL_CRUDE((BigDecimal)( objectArray[45]));}
			if(null!=objectArray[46] && objectArray[46]!=null) {
			temp.setACTUAL_POL_OTHER((BigDecimal)( objectArray[46]));}
			if(null!=objectArray[47] && objectArray[47]!=null) {
			temp.setACTUAL_NON_POL((BigDecimal)( objectArray[47]));}
			if(null!=objectArray[48] && objectArray[48]!=null) {
			temp.setACTUAL_GROSS_TOTAL((BigDecimal)( objectArray[48]));}
			if(null!=objectArray[49] && objectArray[49]!=null) {
			temp.setACTUAL_REFUND((BigDecimal)( objectArray[49]));}
			
			if(null!=objectArray[50] && objectArray[50]!=null) {
			temp.setACTUAL_REBATE((BigDecimal)( objectArray[50]));}
			if(null!=objectArray[51] && objectArray[51]!=null) {
			temp.setACTUAL_REBATE_CEX((BigDecimal)( objectArray[51]));}
			if(null!=objectArray[52] && objectArray[52]!=null) {
			temp.setACTUAL_TOTAL((BigDecimal)( objectArray[52]));}
			if(null!=objectArray[53] && objectArray[53]!=null) {
			temp.setPOL_CRUDE_PERCENT_UPTO((BigDecimal)( objectArray[53]));}
			if(null!=objectArray[54] && objectArray[54]!=null) {
			temp.setPOL_OTHER_PERCENT_UPTO((BigDecimal)( objectArray[54]));}
			if(null!=objectArray[55] && objectArray[55]!=null) {
			temp.setNON_POL_PERCENT_UPTO((BigDecimal)( objectArray[55]));}
			if(null!=objectArray[56] && objectArray[56]!=null) {
			temp.setTOTAL_GROSS_PERCENT_UPTO((BigDecimal)( objectArray[56]));}
			if(null!=objectArray[57] && objectArray[57]!=null) {
			temp.setREFUND_PERCENT_UPTO((BigDecimal)( objectArray[57]));}
			if(null!=objectArray[58] && objectArray[58]!=null) {
			temp.setREBATE_PERCENT_UPTO((BigDecimal)( objectArray[58]));}
			if(null!=objectArray[59] && objectArray[59]!=null) {
			temp.setREBATE_CEX_PERCENT_UPTO((BigDecimal)( objectArray[59]));}
			
			
			if(null!=objectArray[60] && objectArray[60]!=null) {
			temp.setTOTAL_PERCENT_UPTO((BigDecimal)( objectArray[60]));}
			if(null!=objectArray[61] && objectArray[61]!=null) {
			temp.setTOTAL_TARGET_ACTUAL((BigDecimal)( objectArray[61]));}
			if(null!=objectArray[62] && objectArray[62]!=null) {
			temp.setTOTAL_TARGET_PERCENT_UPTO((BigDecimal)( objectArray[62]));}
