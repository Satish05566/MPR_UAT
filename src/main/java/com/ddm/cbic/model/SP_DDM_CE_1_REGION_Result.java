...
public class SP_DDM_CE_1_REGION_Result {
	...
	public List<SP_DDM_CE_1_REGION_Result> sp_DDM_CE_1_REGION_Result(List<Object[]> listObjectArray){
		List <SP_DDM_CE_1_REGION_Result> list = new ArrayList<SP_DDM_CE_1_REGION_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_CE_1_REGION_Result temp = new SP_DDM_CE_1_REGION_Result();
		temp = generateResultBean_SP_DDM_CE_1_REGION(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_CE_1_REGION_Result generateResultBean_SP_DDM_CE_1_REGION(Object[] objectArray)
		{
			SP_DDM_CE_1_REGION_Result temp = new SP_DDM_CE_1_REGION_Result();
			...
			temp.setPOL_CRUDE_FOR_C((BigDecimal)( objectArray[12]));}
			if(null!=objectArray[13] && objectArray[13]!=null) {
			temp.setPOL_OTHER_FOR_C((BigDecimal)( objectArray[13]));}
			if(null!=objectArray[14] && objectArray[14]!=null) {
			temp.setNON_POL_FOR_C((BigDecimal)( objectArray[14]));}
			
			if(null!=objectArray[15] && objectArray[15]!=null) {
			temp.setTOTAL_GROSS_FOR_C((BigDecimal)( objectArray[15]));}
			if(null!=objectArray[16] && objectArray[16]!=null) {
			temp.setREFUND_FOR_C((BigDecimal)( objectArray[16]));}
			if(null!=objectArray[17] && objectArray[17]!=null) {
			temp.setREBATE_FOR_C((BigDecimal)( objectArray[17]));}
			if(null!=objectArray[18] && objectArray[18]!=null) {
			temp.setTOTAL_FOR_C((BigDecimal)( objectArray[18]));}
			if(null!=objectArray[19] && objectArray[19]!=null) {
			temp.setPOL_CRUDE_FOR_P((BigDecimal)( objectArray[19]));}
			if(null!=objectArray[20] && objectArray[20]!=null) {
			temp.setPOL_OTHER_FOR_P((BigDecimal)( objectArray[20]));}
			if(null!=objectArray[21] && objectArray[21]!=null) {
			temp.setNON_POL_FOR_P((BigDecimal)( objectArray[21]));}
			if(null!=objectArray[22] && objectArray[22]!=null) {
			temp.setTOTAL_GROSS_FOR_P((BigDecimal)( objectArray[22]));}
			if(null!=objectArray[23] && objectArray[23]!=null) {
			temp.setREFUND_FOR_P((BigDecimal)( objectArray[23]));}
			if(null!=objectArray[24] && objectArray[24]!=null) {
			temp.setREBATE_FOR_P((BigDecimal)( objectArray[24]));}
			if(null!=objectArray[25] && objectArray[25]!=null) {
			temp.setTOTAL_FOR_P((BigDecimal)( objectArray[25]));}
			if(null!=objectArray[26] && objectArray[26]!=null) {
			temp.setPOL_CRUDE_UPTO_C((BigDecimal)( objectArray[26]));}
			if(null!=objectArray[27] && objectArray[27]!=null) {
			temp.setPOL_OTHER_UPTO_C((BigDecimal)( objectArray[27]));}
			if(null!=objectArray[28] && objectArray[28]!=null) {
			temp.setNON_POL_UPTO_C((BigDecimal)( objectArray[28]));}
			if(null!=objectArray[29] && objectArray[29]!=null) {
			temp.setTOTAL_GROSS_UPTO_C((BigDecimal)( objectArray[29]));}
			if(null!=objectArray[30] && objectArray[30]!=null) {
			temp.setREFUND_UPTO_C((BigDecimal)( objectArray[30]));}
			if(null!=objectArray[31] && objectArray[31]!=null) {
			temp.setREBATE_UPTO_C((BigDecimal)( objectArray[31]));}
			
			
			if(null!=objectArray[32] && objectArray[32]!=null) {
			temp.setTOTAL_UPTO_C((BigDecimal)( objectArray[32]));}
			if(null!=objectArray[33] && objectArray[33]!=null) {
			temp.setPOL_CRUDE_UPTO_P((BigDecimal)( objectArray[33]));}
			if(null!=objectArray[34] && objectArray[34]!=null) {
			temp.setPOL_OTHER_UPTO_P((BigDecimal)( objectArray[34]));}
			if(null!=objectArray[35] && objectArray[35]!=null) {
			temp.setNON_POL_UPTO_P((BigDecimal)( objectArray[35]));}
			if(null!=objectArray[36] && objectArray[36]!=null) {
			temp.setTOTAL_GROSS_UPTO_P((BigDecimal)( objectArray[36]));}
			if(null!=objectArray[37] && objectArray[37]!=null) {
			temp.setREFUND_UPTO_P((BigDecimal)( objectArray[37]));}
			if(null!=objectArray[38] && objectArray[38]!=null) {
			temp.setREBATE_UPTO_P((BigDecimal)( objectArray[38]));}
			...
			temp.setACTUAL_POL_CRUDE((BigDecimal)( objectArray[40]));}
			if(null!=objectArray[41] && objectArray[41]!=null) {
			temp.setACTUAL_POL_OTHER((BigDecimal)( objectArray[41]));}
			if(null!=objectArray[42] && objectArray[42]!=null) {
			temp.setACTUAL_NON_POL((BigDecimal)( objectArray[42]));}
			if(null!=objectArray[43] && objectArray[43]!=null) {
			temp.setACTUAL_GROSS_TOTAL((BigDecimal)( objectArray[43]));}
			if(null!=objectArray[44] && objectArray[44]!=null) {
			temp.setACTUAL_REFUND((BigDecimal)( objectArray[44]));}
			
			if(null!=objectArray[45] && objectArray[45]!=null) {
			temp.setACTUAL_REBATE((BigDecimal)( objectArray[45]));}
			if(null!=objectArray[46] && objectArray[46]!=null) {
			temp.setACTUAL_TOTAL((BigDecimal)( objectArray[46]));}
			if(null!=objectArray[47] && objectArray[47]!=null) {
			temp.setPOL_CRUDE_PERCENT_UPTO((BigDecimal)( objectArray[47]));}
			if(null!=objectArray[48] && objectArray[48]!=null) {
			temp.setPOL_OTHER_PERCENT_UPTO((BigDecimal)( objectArray[48]));}
			if(null!=objectArray[49] && objectArray[49]!=null) {
			temp.setNON_POL_PERCENT_UPTO((BigDecimal)( objectArray[49]));}
			
			if(null!=objectArray[50] && objectArray[50]!=null) {
			temp.setTOTAL_GROSS_PERCENT_UPTO((BigDecimal)( objectArray[50]));}
			if(null!=objectArray[51] && objectArray[51]!=null) {
			temp.setREFUND_PERCENT_UPTO((BigDecimal)( objectArray[51]));}
			if(null!=objectArray[52] && objectArray[52]!=null) {
			temp.setREBATE_PERCENT_UPTO((BigDecimal)( objectArray[52]));}
			if(null!=objectArray[53] && objectArray[53]!=null) {
			temp.setTOTAL_PERCENT_UPTO((BigDecimal)( objectArray[53]));}
			if(null!=objectArray[54] && objectArray[54]!=null) {
			temp.setTOTAL_TARGET_ACTUAL((BigDecimal)( objectArray[54]));}
			if(null!=objectArray[55] && objectArray[55]!=null) {
			temp.setTOTAL_TARGET_PERCENT_UPTO((BigDecimal)( objectArray[55]));}
