...
public class SP_DDM_CE_2_ALL_Result {
    public int AMND ;
	...
	public List<SP_DDM_CE_2_ALL_Result> sp_DDM_CE_1_REGION_Result(List<Object[]> listObjectArray){
		List <SP_DDM_CE_2_ALL_Result> list = new ArrayList<SP_DDM_CE_2_ALL_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_CE_2_ALL_Result temp = new SP_DDM_CE_2_ALL_Result();
		temp = generateResultBean_SP_DDM_CE_2_ALL(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_CE_2_ALL_Result generateResultBean_SP_DDM_CE_2_ALL(Object[] objectArray)
		{
			SP_DDM_CE_2_ALL_Result temp = new SP_DDM_CE_2_ALL_Result();
