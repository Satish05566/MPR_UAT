...
public class SP_DDM_CE_4_ALL_Result {
 int AMND ;
 int TOTAL_COMM ;
 int COMPLETE_COMM ;
...
public  List<SP_DDM_CE_4_ALL_Result> generateResultList_SP_DDM_CE_4_ALL(List<Object []> listObjectArray) {
	List <SP_DDM_CE_4_ALL_Result> list =  new ArrayList<SP_DDM_CE_4_ALL_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_DDM_CE_4_ALL_Result temp = new SP_DDM_CE_4_ALL_Result ();
...
public  SP_DDM_CE_4_ALL_Result generateResultBean(Object [] objectArray) {
	SP_DDM_CE_4_ALL_Result temp =  new SP_DDM_CE_4_ALL_Result();
