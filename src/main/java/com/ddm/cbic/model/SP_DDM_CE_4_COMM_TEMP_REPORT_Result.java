...
public class SP_DDM_CE_4_COMM_TEMP_REPORT_Result {
 String TOTAL_COMM ;
 int COMPLETE_COMM ;
 BigInteger AMND ;
...
public  List<SP_DDM_CE_4_COMM_TEMP_REPORT_Result> generateResultList_SP_DDM_CE_4_COMM_TEMP_REPORT(List<Object []> listObjectArray) {
	List <SP_DDM_CE_4_COMM_TEMP_REPORT_Result> list =  new ArrayList<SP_DDM_CE_4_COMM_TEMP_REPORT_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_DDM_CE_4_COMM_TEMP_REPORT_Result temp = new SP_DDM_CE_4_COMM_TEMP_REPORT_Result ();
...
public  SP_DDM_CE_4_COMM_TEMP_REPORT_Result generateResultBean(Object [] objectArray) {
	SP_DDM_CE_4_COMM_TEMP_REPORT_Result temp =  new SP_DDM_CE_4_COMM_TEMP_REPORT_Result();
