...
public class SP_DDM_CE_4_REGION_Result {
 int TOTAL_COMM ;
 int AMND ;
 int COMPLETE_COMM ;
...
public void setASSESSEE_CODE(String ASSESSEE_CODE) {
	this.ASSESSEE_CODE=ASSESSEE_CODE;
}
...
public  List<SP_DDM_CE_4_REGION_Result> generateResultList_SP_DDM_CE_4_REGION(List<Object []> listObjectArray) {
	List <SP_DDM_CE_4_REGION_Result> list =  new ArrayList<SP_DDM_CE_4_REGION_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_DDM_CE_4_REGION_Result temp = new SP_DDM_CE_4_REGION_Result ();
...
public  SP_DDM_CE_4_REGION_Result generateResultBean(Object [] objectArray) {
	SP_DDM_CE_4_REGION_Result temp =  new SP_DDM_CE_4_REGION_Result();
