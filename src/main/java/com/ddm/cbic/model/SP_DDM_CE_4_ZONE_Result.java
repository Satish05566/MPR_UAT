...
public class SP_DDM_CE_4_ZONE_Result {
 int TOTAL_COMM ;
 int AMND ;
 int COMPLETE_COMM ;
...
public  List<SP_DDM_CE_4_ZONE_Result> generateResultList_SP_DDM_CE_4_ZONE(List<Object []> listObjectArray) {
	List <SP_DDM_CE_4_ZONE_Result> list =  new ArrayList<SP_DDM_CE_4_ZONE_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_DDM_CE_4_ZONE_Result temp = new SP_DDM_CE_4_ZONE_Result ();
...
public  SP_DDM_CE_4_ZONE_Result generateResultBean(Object [] objectArray) {
	SP_DDM_CE_4_ZONE_Result temp =  new SP_DDM_CE_4_ZONE_Result();
