...
import java.util.List;
    ...
    public class SP_DDM_CE_6_ALL_Result
    {
        public String S_NO ;
        public String AMND ;
		...
		public List<SP_DDM_CE_6_ALL_Result> generateResultList_SP_DDM_CE_6_ALL(List<Object[]> listObjectArray){
			List <SP_DDM_CE_6_ALL_Result> list = new ArrayList<SP_DDM_CE_6_ALL_Result>();
			for(Object[] objArray : listObjectArray) {
			SP_DDM_CE_6_ALL_Result temp = new SP_DDM_CE_6_ALL_Result();
			temp = generateResultBean(objArray);
			list.add(temp);
			}
			return list;
			}
		public SP_DDM_CE_6_ALL_Result generateResultBean(Object[] objectArray)
		{
		SP_DDM_CE_6_ALL_Result temp = new SP_DDM_CE_6_ALL_Result();
		...
		temp.setTOTAL_COMM(String.valueOf(objectArray[2]));
		temp.setCOMPLETE_COMM(String.valueOf(objectArray[3]));
		temp.setCOMMODITY_GROUP(String.valueOf(objectArray[4]));
		temp.setPRE_PLA(String.valueOf(objectArray[5]));
		temp.setPRE_CENVAT(String.valueOf(objectArray[6]));
		temp.setPRE_PLA_FOR_P(String.valueOf(objectArray[7]));
		temp.setPRE_CENVAT_FOR_P(String.valueOf(objectArray[8]));
		temp.setPRE_PLA_UPTO_P(String.valueOf(objectArray[9]));
		temp.setPRE_CENVAT_UPTO_P(String.valueOf(objectArray[10]));
		temp.setCURR_PLA_FOR_C(String.valueOf(objectArray[11]));
		temp.setCURR_CENVAT_FOR_C(String.valueOf(objectArray[12]));
		temp.setCURR_PLA_UPTO_C(String.valueOf(objectArray[13]));
		temp.setCURR_CENVAT_UPTO_C(String.valueOf(objectArray[14]));
		temp.setACTUAL_UPTO_PLA(String.valueOf(objectArray[15]));
		temp.setACTUAL_UPTO_CENVAT(String.valueOf(objectArray[16]));
		temp.setPERCEN_PLA(String.valueOf(objectArray[17]));
		temp.setPERCEN_CENVAT(String.valueOf(objectArray[18]));
