...
import java.util.List;    
    public class SP_DDM_CE_6_REGION_Result
    {
        public String S_NO ;
        public String AMND ;
		...
		public List<SP_DDM_CE_6_REGION_Result> generateResultList_SP_DDM_CE_6_REGION(List<Object[]> listObjectArray){
			 List <SP_DDM_CE_6_REGION_Result> list = new ArrayList<SP_DDM_CE_6_REGION_Result>();
			 for(Object[] objArray : listObjectArray) {
				 SP_DDM_CE_6_REGION_Result temp = new SP_DDM_CE_6_REGION_Result();
			 temp = generateResultBean_SP_DDM_CE_6_REGION(objArray);
			 list.add(temp);
			 }
			 return list;
			 }
			...
			public SP_DDM_CE_6_REGION_Result generateResultBean_SP_DDM_CE_6_REGION(Object[] objectArray)
			{
			SP_DDM_CE_6_REGION_Result temp = new SP_DDM_CE_6_REGION_Result();
			...
			temp.setREGION_CODE((String)(objectArray[4]));
			temp.setCOMMODITY_GROUP((String)(objectArray[5]));
			
			
			temp.setPRE_PLA((String)(objectArray[6]));
			temp.setPRE_CENVAT((String)(objectArray[7]));
			
			temp.setPRE_PLA_FOR_P((String)(objectArray[8]));
			temp.setPRE_CENVAT_FOR_P((String)(objectArray[9]));
			
			temp.setPRE_PLA_UPTO_P((String)(objectArray[10]));
			temp.setPRE_CENVAT_UPTO_P((String)(objectArray[11]));
			
			temp.setCURR_PLA_FOR_C((String)(objectArray[12]));
