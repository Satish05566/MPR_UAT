...
import java.util.List;    
    public class SP_DDM_CE_6_ZONE_Result
    {
        public String S_NO ;
        public String AMND ;
		...
		public List<SP_DDM_CE_6_ZONE_Result> generateResultList_SP_DDM_CE_6_ZONE(List<Object[]> listObjectArray){
			 List <SP_DDM_CE_6_ZONE_Result> list = new ArrayList<SP_DDM_CE_6_ZONE_Result>();
			 for(Object[] objArray : listObjectArray) {
				 SP_DDM_CE_6_ZONE_Result temp = new SP_DDM_CE_6_ZONE_Result();
			 temp = generateResultBean_SP_DDM_CE_6_ZONE(objArray);
			 list.add(temp);
			 }
			 return list;
			 }
			...
			public SP_DDM_CE_6_ZONE_Result generateResultBean_SP_DDM_CE_6_ZONE(Object[] objectArray)
			{
			SP_DDM_CE_6_ZONE_Result temp = new SP_DDM_CE_6_ZONE_Result();
	        ...
	        temp.setPRE_PLA_UPTO_P (String.valueOf(objectArray[10]));
