...
public  class SP_DDM_CUS_6_ALL_Result
{
	...
	public List<SP_DDM_CUS_6_ALL_Result> generateResultList_SP_DDM_CUS_6_ALL(List<Object[]> listObjectArray){
		List <SP_DDM_CUS_6_ALL_Result> list = new ArrayList<SP_DDM_CUS_6_ALL_Result>();
		for(Object[] objArray : listObjectArray) {
		SP_DDM_CUS_6_ALL_Result temp = new SP_DDM_CUS_6_ALL_Result();
		temp = generateResultBean(objArray);
		list.add(temp);
		}
		return list;
		}
	public SP_DDM_CUS_6_ALL_Result generateResultBean(Object[] objectArray)
	{
	SP_DDM_CUS_6_ALL_Result temp = new SP_DDM_CUS_6_ALL_Result();
	...
	temp.setCOMMODITY_GROUP(String.valueOf(objectArray[1]));
	temp.setACTUAL_FOR(String.valueOf(objectArray[2]));
	temp.setACTUAL_FOR_P(String.valueOf(objectArray[3]));
	temp.setACTUAL_UPTO_P(String.valueOf(objectArray[4]));
	temp.setACTUAL_FOR_C(String.valueOf(objectArray[5]));
	temp.setACTUAL_UPTO_C(String.valueOf(objectArray[6]));
	temp.setACTUAL_UPTO_ACTUAL(String.valueOf(objectArray[7]));
	temp.setACTUAL_UPTO_PER(String.valueOf(objectArray[8]));
	temp.setAMND((int)(objectArray[9]));
