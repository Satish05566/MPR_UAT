...
public  class SP_DDM_CUS_6_REGION_Result
{
	...
	public String getREGIONE_CODE() {
		return REGIONE_CODE;
	}


	public void setREGIONE_CODE(String rEGIONE_CODE) {
		REGIONE_CODE = rEGIONE_CODE;
	}
	...
	public List<SP_DDM_CUS_6_REGION_Result> generateResultList_SP_DDM_CUS_6_REGION(List<Object[]> listObjectArray){
	List <SP_DDM_CUS_6_REGION_Result> list = new ArrayList<SP_DDM_CUS_6_REGION_Result>();
	for(Object[] objArray : listObjectArray) {
	SP_DDM_CUS_6_REGION_Result temp = new SP_DDM_CUS_6_REGION_Result();
	...
	public SP_DDM_CUS_6_REGION_Result generateResultBean(Object[] objectArray)
	{
	SP_DDM_CUS_6_REGION_Result temp = new SP_DDM_CUS_6_REGION_Result();
	
	
	temp.setS_NO(String.valueOf(objectArray[0]));
	temp.setREGIONE_CODE(String.valueOf(objectArray[1]));
