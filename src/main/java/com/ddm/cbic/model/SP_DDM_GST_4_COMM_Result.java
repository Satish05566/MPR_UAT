...
public class SP_DDM_GST_4_COMM_Result {
	...
	public List<SP_DDM_GST_4_COMM_Result> SP_DDM_GST_4_COMM_Result(List<Object[]> listObjectArray){
		List <SP_DDM_GST_4_COMM_Result> list = new ArrayList<SP_DDM_GST_4_COMM_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_GST_4_COMM_Result temp = new SP_DDM_GST_4_COMM_Result();
		temp = generateResultBean_SP_DDM_GST_4_COMM(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_GST_4_COMM_Result generateResultBean_SP_DDM_GST_4_COMM(Object[] objectArray)
		{
			SP_DDM_GST_4_COMM_Result temp = new SP_DDM_GST_4_COMM_Result();
				...
				if(null!=objectArray[1] && objectArray[1]!=null) {
					temp.setAMND(Integer.parseInt( objectArray[1].toString()));}
				if(null!=objectArray[2] && objectArray[2]!=null) {
				temp.setCOMPLETE_COMM(Integer.parseInt( objectArray[2].toString()));}
		...
		public String toString() {
			return "SP_DDM_GST_4_COMM_Result [TOTAL_COMM=" + TOTAL_COMM + ", AMND=" + AMND + ", COMPLETE_COMM="
