...
public class SP_DDM_GST_4_COMM_TEMP_REPORT_Result {
	...
	public List<SP_DDM_GST_4_COMM_TEMP_REPORT_Result> SP_DDM_GST_4_COMM_TEMP_REPORT_Result(List<Object[]> listObjectArray){
		...
		temp = generateResultBean_SP_DDM_GST_4_COMM_TEMP_REPORT(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_GST_4_COMM_TEMP_REPORT_Result generateResultBean_SP_DDM_GST_4_COMM_TEMP_REPORT(Object[] objectArray)
		{
			SP_DDM_GST_4_COMM_TEMP_REPORT_Result temp = new SP_DDM_GST_4_COMM_TEMP_REPORT_Result();
				...
				temp.setCOMPLETE_COMM((int)( objectArray[1]));}
		...
		public String toString() {
			return "SP_DDM_GST_4_COMM_TEMP_REPORT_Result [TOTAL_COMM=" + TOTAL_COMM + ", COMPLETE_COMM=" + COMPLETE_COMM
					+ ", AMND=" + AMND + ", GST_ASSESSEE_CODE=" + GST_ASSESSEE_CODE + ", GST_ASSESSEE=" + GST_ASSESSEE
