...
public class SP_DDM_ST_1_ALL_Result {
	public int AMND ;
	...
	public List<SP_DDM_ST_1_ALL_Result> SP_DDM_ST_1_ALL_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_1_ALL_Result> list = new ArrayList<SP_DDM_ST_1_ALL_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_1_ALL_Result temp = new SP_DDM_ST_1_ALL_Result();
		temp = generateResultBean_SP_DDM_ST_1_ALL(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_ST_1_ALL_Result generateResultBean_SP_DDM_ST_1_ALL(Object[] objectArray)
		{
			SP_DDM_ST_1_ALL_Result temp = new SP_DDM_ST_1_ALL_Result();
			...
			temp.setREBATE_STX((BigDecimal)( objectArray[6]));}
			if(null!=objectArray[7] && objectArray[7]!=null) {
			temp.setTOTAL_FY((BigDecimal)( objectArray[7]));}
			if(null!=objectArray[8] && objectArray[8]!=null) {
			temp.setTOTAL_TARGET_UPTO((BigDecimal)( objectArray[8]));}
			if(null!=objectArray[9] && objectArray[9]!=null) {
			temp.setTOTAL_TARGET_FOR((BigDecimal)( objectArray[9]));}
			if(null!=objectArray[10] && objectArray[10]!=null) {
			temp.setGROSS_FOR_C((BigDecimal)( objectArray[10]));}
					
			if(null!=objectArray[11] && objectArray[11]!=null) {
			temp.setREFUND_FOR_C((BigDecimal)( objectArray[11]));}
			if(null!=objectArray[12] && objectArray[12]!=null) {
			temp.setREBATE_FOR_C((BigDecimal)( objectArray[12]));}
			if(null!=objectArray[13] && objectArray[13]!=null) {
			temp.setREBATE_STX_FOR_C((BigDecimal)( objectArray[13]));}
			if(null!=objectArray[14] && objectArray[14]!=null) {
			temp.setTOTAL_FOR_C((BigDecimal)( objectArray[14]));}
			if(null!=objectArray[15] && objectArray[15]!=null) {
			temp.setGROSS_FOR_P((BigDecimal)( objectArray[15]));}
			if(null!=objectArray[16] && objectArray[16]!=null) {
			temp.setREFUND_FOR_P((BigDecimal)( objectArray[16]));}
			if(null!=objectArray[17] && objectArray[17]!=null) {
			temp.setREBATE_FOR_P((BigDecimal)( objectArray[17]));}
			
			if(null!=objectArray[18] && objectArray[18]!=null) {
			temp.setREBATE_STX_FOR_P((BigDecimal)( objectArray[18]));}
			if(null!=objectArray[19] && objectArray[19]!=null) {
			temp.setTOTAL_FOR_P((BigDecimal)( objectArray[19]));}
			if(null!=objectArray[20] && objectArray[20]!=null) {
			temp.setGROSS_UPTO_C((BigDecimal)( objectArray[20]));}
			if(null!=objectArray[21] && objectArray[21]!=null) {
			temp.setREFUND_UPTO_C((BigDecimal)( objectArray[21]));}
			if(null!=objectArray[22] && objectArray[22]!=null) {
			temp.setREBATE_UPTO_C((BigDecimal)( objectArray[22]));}
			if(null!=objectArray[23] && objectArray[23]!=null) {
			temp.setREBATE_STX_UPTO_C((BigDecimal)( objectArray[23]));}
			...
			temp.setGROSS_UPTO_P((BigDecimal)( objectArray[25]));}
			if(null!=objectArray[26] && objectArray[26]!=null) {
			temp.setREFUND_UPTO_P((BigDecimal)( objectArray[26]));}
			if(null!=objectArray[27] && objectArray[27]!=null) {
			temp.setREBATE_UPTO_P((BigDecimal)( objectArray[27]));}
			if(null!=objectArray[28] && objectArray[28]!=null) {
			temp.setREBATE_STX_UPTO_P((BigDecimal)( objectArray[28]));}
			
			if(null!=objectArray[29] && objectArray[29]!=null) {
			temp.setTOTAL_UPTO_P((BigDecimal)( objectArray[29]));}
			if(null!=objectArray[30] && objectArray[30]!=null) {
			temp.setACTUAL_GROSS((BigDecimal)( objectArray[30]));}
			if(null!=objectArray[31] && objectArray[31]!=null) {
			temp.setACTUAL_REFUND((BigDecimal)( objectArray[31]));}
			if(null!=objectArray[32] && objectArray[32]!=null) {
			temp.setACTUAL_REBATE((BigDecimal)( objectArray[32]));}
			
			if(null!=objectArray[33] && objectArray[33]!=null) {
			temp.setACTUAL_REBATE_STX((BigDecimal)( objectArray[33]));}
			if(null!=objectArray[34] && objectArray[34]!=null) {
			temp.setACTUAL_TOTAL((BigDecimal)( objectArray[34]));}
			if(null!=objectArray[35] && objectArray[35]!=null) {
			temp.setGROSS_PERCENT_UPTO((BigDecimal)( objectArray[35]));}
			if(null!=objectArray[36] && objectArray[36]!=null) {
			temp.setREFUND_PERCENT_UPTO((BigDecimal)( objectArray[36]));}
			
			if(null!=objectArray[37] && objectArray[37]!=null) {
			temp.setREBATE_PERCENT_UPTO((BigDecimal)( objectArray[37]));}
			if(null!=objectArray[38] && objectArray[38]!=null) {
			temp.setREBATE_STX_PERCENT_UPTO((BigDecimal)( objectArray[38]));}
			if(null!=objectArray[39] && objectArray[39]!=null) {
			temp.setTOTAL_PERCENT_UPTO((BigDecimal)( objectArray[39]));}
			if(null!=objectArray[40] && objectArray[40]!=null) {
			temp.setTOTAL_TARGET_ACTUAL((BigDecimal)( objectArray[40]));}
			if(null!=objectArray[41] && objectArray[41]!=null) {
			temp.setTOTAL_TARGET_PERCENT_UPTO((BigDecimal)( objectArray[41]));}		
