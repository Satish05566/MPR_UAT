...
public class SP_DDM_ST_1_COMM_TEMP_REPORT_Result {
	...
	public SP_DDM_ST_1_COMM_TEMP_REPORT_Result generateResultBean_SP_DDM_ST_1_COMM_TEMP_REPORT(Object[] objectArray)
	{
		SP_DDM_ST_1_COMM_TEMP_REPORT_Result temp = new SP_DDM_ST_1_COMM_TEMP_REPORT_Result();
		...
		temp.setCOMM_CODE((String)( objectArray[9]));}
		...
		temp.setTOTAL_FOR_C((BigDecimal)( objectArray[13]));}
		
		if(null!=objectArray[14] && objectArray[14]!=null) {
		temp.setGROSS_FOR_P((BigDecimal)( objectArray[14]));}
		if(null!=objectArray[15] && objectArray[15]!=null) {
		temp.setREFUND_FOR_P((BigDecimal)( objectArray[15]));}
		if(null!=objectArray[16] && objectArray[16]!=null) {
		temp.setREBATE_FOR_P((BigDecimal)( objectArray[16]));}
		if(null!=objectArray[17] && objectArray[17]!=null) {
		temp.setTOTAL_FOR_P((BigDecimal)( objectArray[17]));}		
		if(null!=objectArray[18] && objectArray[18]!=null) {
		temp.setGROSS_UPTO_C((BigDecimal)( objectArray[18]));}
		if(null!=objectArray[19] && objectArray[19]!=null) {
		temp.setREFUND_UPTO_C((BigDecimal)( objectArray[19]));}
		if(null!=objectArray[20] && objectArray[20]!=null) {
		temp.setREBATE_UPTO_C((BigDecimal)( objectArray[20]));}
		
		
		if(null!=objectArray[21] && objectArray[21]!=null) {
		temp.setTOTAL_UPTO_C((BigDecimal)( objectArray[21]));}
		if(null!=objectArray[22] && objectArray[22]!=null) {
		temp.setGROSS_UPTO_P((BigDecimal)( objectArray[22]));}
		if(null!=objectArray[23] && objectArray[23]!=null) {
		temp.setREFUND_UPTO_P((BigDecimal)( objectArray[23]));}
		if(null!=objectArray[24] && objectArray[24]!=null) {
		temp.setREBATE_UPTO_P((BigDecimal)( objectArray[24]));}
		if(null!=objectArray[25] && objectArray[25]!=null) {
		temp.setTOTAL_UPTO_P((BigDecimal)( objectArray[25]));}
		
		if(null!=objectArray[26] && objectArray[26]!=null) {
		temp.setACTUAL_GROSS((BigDecimal)( objectArray[26]));}
		if(null!=objectArray[27] && objectArray[27]!=null) {
		temp.setACTUAL_REFUND((BigDecimal)( objectArray[27]));}
		if(null!=objectArray[28] && objectArray[28]!=null) {
		temp.setACTUAL_REBATE((BigDecimal)( objectArray[28]));}
		if(null!=objectArray[29] && objectArray[29]!=null) {
		temp.setACTUAL_TOTAL((BigDecimal)( objectArray[29]));}
		
		if(null!=objectArray[30] && objectArray[30]!=null) {
		temp.setGROSS_PERCENT_UPTO((BigDecimal)( objectArray[30]));}
		if(null!=objectArray[31] && objectArray[31]!=null) {
		temp.setREFUND_PERCENT_UPTO((BigDecimal)( objectArray[31]));}
		
		if(null!=objectArray[32] && objectArray[32]!=null) {
		temp.setREBATE_PERCENT_UPTO((BigDecimal)( objectArray[32]));}
		if(null!=objectArray[33] && objectArray[33]!=null) {
		temp.setTOTAL_PERCENT_UPTO((BigDecimal)( objectArray[33]));}
		if(null!=objectArray[34] && objectArray[34]!=null) {
		temp.setTOTAL_TARGET_ACTUAL((BigDecimal)( objectArray[34]));}
		if(null!=objectArray[35] && objectArray[35]!=null) {
		temp.setTOTAL_TARGET_PERCENT_UPTO((BigDecimal)( objectArray[35]));}
