...
public class SP_DDM_ST_2_ALL_Result {
	...
	public List<SP_DDM_ST_2_ALL_Result> SP_DDM_ST_2_ALL_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_2_ALL_Result> list = new ArrayList<SP_DDM_ST_2_ALL_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_2_ALL_Result temp = new SP_DDM_ST_2_ALL_Result();
		temp = generateResultBean_SP_DDM_ST_2_ALL(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_ST_2_ALL_Result generateResultBean_SP_DDM_ST_2_ALL(Object[] objectArray)
		{
			SP_DDM_ST_2_ALL_Result temp = new SP_DDM_ST_2_ALL_Result();
