...
public class SP_DDM_ST_2_COMM_Result {
	...
	public List<SP_DDM_ST_2_COMM_Result> SP_DDM_ST_2_COMM_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_2_COMM_Result> list = new ArrayList<SP_DDM_ST_2_COMM_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_2_COMM_Result temp = new SP_DDM_ST_2_COMM_Result();
		temp = generateResultBean_SP_DDM_ST_2_COMM(objArray);
		list.add(temp);
		}
		return list;
		}

	public SP_DDM_ST_2_COMM_Result generateResultBean_SP_DDM_ST_2_COMM(Object[] objectArray)
	{
		SP_DDM_ST_2_COMM_Result temp = new SP_DDM_ST_2_COMM_Result();
