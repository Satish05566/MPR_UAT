...
public class SP_DDM_ST_2_REGION_Result {
	...
	public List<SP_DDM_ST_2_REGION_Result> SP_DDM_ST_2_REGION_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_2_REGION_Result> list = new ArrayList<SP_DDM_ST_2_REGION_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_2_REGION_Result temp = new SP_DDM_ST_2_REGION_Result();
		temp = generateResultBean_SP_DDM_ST_2_REGION(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_ST_2_REGION_Result generateResultBean_SP_DDM_ST_2_REGION(Object[] objectArray)
		{
			SP_DDM_ST_2_REGION_Result temp = new SP_DDM_ST_2_REGION_Result();
