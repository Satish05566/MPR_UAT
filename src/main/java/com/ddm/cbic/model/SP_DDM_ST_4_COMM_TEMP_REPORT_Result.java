...
public class SP_DDM_ST_4_COMM_TEMP_REPORT_Result {
	...
	public List<SP_DDM_ST_4_COMM_TEMP_REPORT_Result> SP_DDM_ST_4_COMM_TEMP_Report_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_4_COMM_TEMP_REPORT_Result> list = new ArrayList<SP_DDM_ST_4_COMM_TEMP_REPORT_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_4_COMM_TEMP_REPORT_Result temp = new SP_DDM_ST_4_COMM_TEMP_REPORT_Result();
		temp = generateResultBean_SP_DDM_ST_4_COMM_TEMP_REPORT(objArray);
		list.add(temp);
		}
		return list;
		}
	...
	public SP_DDM_ST_4_COMM_TEMP_REPORT_Result generateResultBean_SP_DDM_ST_4_COMM_TEMP_REPORT(Object[] objectArray)
	{
		SP_DDM_ST_4_COMM_TEMP_REPORT_Result temp = new SP_DDM_ST_4_COMM_TEMP_REPORT_Result();
