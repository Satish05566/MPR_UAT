...
public class SP_DDM_ST_4_ZONE_Result {
	...
	public List<SP_DDM_ST_4_ZONE_Result> SP_DDM_ST_4_ZONE_Result(List<Object[]> listObjectArray){
		List <SP_DDM_ST_4_ZONE_Result> list = new ArrayList<SP_DDM_ST_4_ZONE_Result>();
		for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_4_ZONE_Result temp = new SP_DDM_ST_4_ZONE_Result();
		temp = generateResultBean_SP_DDM_ST_4_ZONE(objArray);
		list.add(temp);
		}
		return list;
		}

		public SP_DDM_ST_4_ZONE_Result generateResultBean_SP_DDM_ST_4_ZONE(Object[] objectArray)
		{
			SP_DDM_ST_4_ZONE_Result temp = new SP_DDM_ST_4_ZONE_Result();
