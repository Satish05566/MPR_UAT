...
public  class SP_DDM_ST_6_ALL_Result
    {
        public String AMND ;
		...
		public List<SP_DDM_ST_6_ALL_Result> generateResultList_SP_DDM_ST_6_ALL(List<Object[]> listObjectArray){
			List <SP_DDM_ST_6_ALL_Result> list = new ArrayList<SP_DDM_ST_6_ALL_Result>();
			for(Object[] objArray : listObjectArray) {
			SP_DDM_ST_6_ALL_Result temp = new SP_DDM_ST_6_ALL_Result();
			temp = generateResultBean(objArray);
			list.add(temp);
			}
			return list;
			}
		public SP_DDM_ST_6_ALL_Result generateResultBean(Object[] objectArray)
		{
		SP_DDM_ST_6_ALL_Result temp = new SP_DDM_ST_6_ALL_Result();
