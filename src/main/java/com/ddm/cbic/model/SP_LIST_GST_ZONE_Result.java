...
public class SP_LIST_GST_ZONE_Result {
 String ZONE_NAME ;
 String ZONE_CODE ;
...
public  List<SP_LIST_GST_ZONE_Result> generateResultBeanList(List<Object []> listObjectArray) {
	List <SP_LIST_GST_ZONE_Result> list =  new ArrayList<SP_LIST_GST_ZONE_Result>();
...
public  SP_LIST_GST_ZONE_Result generateResultBean(Object [] objectArray) {
	SP_LIST_GST_ZONE_Result temp =  new SP_LIST_GST_ZONE_Result();
