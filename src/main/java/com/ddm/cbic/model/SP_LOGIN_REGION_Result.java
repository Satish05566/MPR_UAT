...
public class SP_LOGIN_REGION_Result {
 String ID ;
 String CODE ;
 String PASS ;
 String NAME ;
...
public  List<SP_LOGIN_REGION_Result> generateResultBeanList(List<Object []> listObjectArray) {
	List <SP_LOGIN_REGION_Result> list =  new ArrayList<SP_LOGIN_REGION_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_LOGIN_REGION_Result temp = new SP_LOGIN_REGION_Result ();
...
public  SP_LOGIN_REGION_Result generateResultBean(Object [] objectArray) {
	SP_LOGIN_REGION_Result temp =  new SP_LOGIN_REGION_Result();
