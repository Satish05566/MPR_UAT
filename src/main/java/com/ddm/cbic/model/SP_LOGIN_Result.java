...
public  List<SP_LOGIN_Result> generateResultBeanList(List<Object []> listObjectArray) {
	List <SP_LOGIN_Result> list =  new ArrayList<SP_LOGIN_Result>();
	for(Object [] objArray : listObjectArray) { 
		SP_LOGIN_Result temp = new SP_LOGIN_Result ();
...
public  SP_LOGIN_Result generateResultBean(Object [] objectArray) {
	SP_LOGIN_Result temp =  new SP_LOGIN_Result();
