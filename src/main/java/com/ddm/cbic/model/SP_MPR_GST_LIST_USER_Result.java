...
public class SP_MPR_GST_LIST_USER_Result {
 long SNO ;
 String CODE ;
 String DEP ;
 String FO ;
...
public  List<SP_MPR_GST_LIST_USER_Result> generateResultBeanList(List<Object []> listObjectArray) {
	List <SP_MPR_GST_LIST_USER_Result> list =  new ArrayList<SP_MPR_GST_LIST_USER_Result>();
	for(Object [] objArray : listObjectArray) { 
	SP_MPR_GST_LIST_USER_Result temp = new SP_MPR_GST_LIST_USER_Result ();
...
public  SP_MPR_GST_LIST_USER_Result generateResultBean(Object [] objectArray) {
	SP_MPR_GST_LIST_USER_Result temp =  new SP_MPR_GST_LIST_USER_Result();
