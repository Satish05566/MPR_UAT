...
<div id="page-wrapper">
    <div class="row">
            ...
            <h4 class="page-header p-b-0 no-border">
                <i class="fa fa-book fa-fw"></i> DDM-GST-3A
            </h4>
    ...
    <!-- /.row -->
     ...
     <div class="row">
    <form:form action="/MPR/GSTDDM/Insert/DDM_GST_3A" id="gstRev3ACommTemp" name = "gstRev3ACommTemp" method="POST"  modelAttribute="gstRev3ACommTemp" >
     <c:choose>
    ...
    <div class="col-lg-12">
        <div class="panel panel-danger">
            <div class="panel-heading text-capitalize">
                 ...
                 Revenue from Taxpayers who fall in the list of Top 5000 Taxpayers (All India)
            </div>
                        ...
                        <tr class="table-header-center text-center-capitalize">
                            ...
                            <tr class="textcenter" id="tr_hidden">
                              <th class="text-center" style="width: 65px;padding: 3px 9px; height: 27px; margin-top: 5px;" >
                                ...
                                <form:input path="SR_NO" type="hidden"
								name="SR_NO" id="SR_NO"
								placeholder="SR_NO NAME" class="form-control min-width-1"
								autocomplete="off" readonly="true" required="true" /> <form:errors
								path="SR_NO" cssClass="error" />
                            ...
                            <c:forEach items="${model}" var="r">
							  ...
							  <tr class="table-datarow-right">
								...
								<th width="15%">${r.NAME_OF_TAXPAYER}</th>
...
$(document).ready(function () {
	...
	$('body'). bind('copy paste',function(e) { e. preventDefault(); return false; });
	 ...
	 $("#gstRev3ACommTemp").validate({
	     rules: {
	    	 lbl_REASONS: "required",
