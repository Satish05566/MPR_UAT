...
<c:set var = "above_1"  value = "${above_1 + r.MORE_YEAR_AMT_FOR}"/>
            ...
            <td align="right" width="7%" height="22px">
				...
				<a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_1AA/All/0/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
