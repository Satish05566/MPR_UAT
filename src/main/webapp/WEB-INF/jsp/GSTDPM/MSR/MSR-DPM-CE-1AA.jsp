     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-1AA(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:set var = "above_1"  value = "${above_1 + r.MORE_YEAR_AMT_FOR}"/>
            ...
            <tr class="grid_head">
                ...
                <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_1AA_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
