     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-1AB(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:set var = "opening_no"  value = "${opening_no + r.OPENING_NO}"/>
<c:set var = "receipts_for"  value = "${receipts_for + r.RECEIPT_NO_FOR}"/>
<c:set var = "receipts_upto"  value = "${receipts_upto + r.RECEIPT_NO_UPTO}"/>
<c:set var = "disposal_for"  value = "${disposal_for + r.DISPOSAL_NO_FOR}"/>
<c:set var = "disposal_upto"  value = "${disposal_upto + r.DISPOSAL_NO_UPTO}"/>
<c:set var = "closing_no"  value = "${closing_no + r.CLOSING_NO}"/>
<c:set var = "less_3"  value = "${less_3 + r.MONTHS_3_AMT_FOR}"/>

<c:set var = "less_6"  value = "${less_6 + r.MONTHS_3TO6_AMT_FOR}"/>
<c:set var = "less_12"  value = "${less_12 + r.MONTHS_6TO12_AMT_FOR}"/>
<c:set var = "above_1"  value = "${above_1 + r.MORE_YEAR_AMT_FOR}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_1AB_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                        ...
                        <td align="right" width="7%" height="22px">
                            ${r.MONTHS_3TO6_AMT_FOR}
                        </td>

                        <td align="right" width="7%" height="22px">
                            ${r.MONTHS_6TO12_AMT_FOR}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.MORE_YEAR_AMT_FOR}
                        </td>
