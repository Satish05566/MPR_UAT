    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-1AE(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:set var = "above_1"  value = "${above_1 + r.SUP_MORE_YEAR_AMT_FOR}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <th align="left" width="25%" height="22px">
                         ...
                         <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_1AE_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
