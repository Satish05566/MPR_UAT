    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-1C(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:if test="${total_oio_upto != 0}">
          <c:set var = "per_30"  value = "${(no_30_upto / total_oio_upto) * 100}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_1C_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                        </th>
