    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-2A(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center" style="font-size:18px;">
                   ...
                   <h2> DETAILS OF ADJUDICATION CASES  INVOLVING CENTRAL EXCISE DUTY OF MORE THAN Rs 1 CRORE AND MORE THAN 1 YEAR</h2>
                </td>
              ...
              <tr>
				...
				<c:set var = "more_1"  value = "${more_1 + r.MORE_THAN_1}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_2A_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                        ...
                        <td align="right" width="4%" height="22px">
                            ...
                            <c:if test="${r.CASES_PERCENT == null}">
	                                                       0
	                                        </c:if> <c:if test="${r.CASES_PERCENT != null}">
	                                           	${r.CASES_PERCENT}
	                                        </c:if>
                        </td>
