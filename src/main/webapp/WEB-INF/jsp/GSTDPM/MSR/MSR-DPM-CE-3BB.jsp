    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=rdOrder]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_3BB/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_3BB/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio1 + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-3BB(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center">
                    ...
                    <h1>MSR-DPM-CE-3BB</h1>

                    <h2>
                        REASONS FOR PENDING CALL BOOK CASES IN <label id="lbl_order">DESCENDING</label>
                         ORDER  ON THE BASIS OF NO.OF CASES PENDING.<br/>
                        CATEGORY:CASES WHERE INJUNCTION HAS BEEN ISSUED BY SC/HC/TRIBUNAL ETC.
                    </h2>
                </td>
                    ...
                    <tr class="grid_head">
                        ...
                        <c:if test="${r.ZONE_CODE!='ZY'}">
                            ...
                            <th align="left" width="25%" height="22px">
                              <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_3BB_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                       ...
                       <c:if test="${r.ZONE_CODE=='ZY'}">
                        ...
                        <td align="right" width="7%" height="22px">
                            ${r.INJUNCTION_MONTHS_3}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.INJUNCTION_MONTHS_3TO6}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.INJUNCTION_MONTHS_6TO12}
                        </td>

                        <td align="right" width="7%" height="22px">
                            ${r.INJUNCTION_YEARS_1TO2}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.INJUNCTION_MORE_2YEAR}
                        </td>
