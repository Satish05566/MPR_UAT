    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=rdOrder]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_3BD/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_3BD/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio1 + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-3BD(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
                 ...
                 <c:forEach var ="r" items="${Model}" >
                    ...
                    <tr class="grid_head">
                        ...
                        <c:if test="${r.ZONE_CODE!='ZY'}">
                            ...
                            <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_3BD_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
