    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=rdOrder]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_REFUND_4A/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CE_REFUND_4A/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio1 + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-CE-4A(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
                    ...
                    <tr class="grid_head">
                        ...
                        <c:if test="${r.ZONE_CODE!='ZY'}">
                            ...
                            <th align="left" width="12%" height="22px">
								...
								<a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CE_REFUND_4A_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                            </th>
                        </c:if>
                       <c:if test="${r.ZONE_CODE=='ZY'}">
                            <th align="left" width="12%" height="22px">
                        ...
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MONTHS_3TO6_NO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MONTHS_3TO6_AMT}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MONTHS_6TO12_NO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MONTHS_6TO12_AMT}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MORE_YEAR_NO}
                        </td>
                        ...
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MORE_3MONTHS_NO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.REF_MORE_3MONTHS_AMT}
                        </td>     
                    </tr>
               </c:forEach>
