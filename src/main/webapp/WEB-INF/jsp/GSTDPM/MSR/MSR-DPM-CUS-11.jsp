                       ...
                       <c:if test="${!(r.SNO != 100)}">
                        ...
                        <c:if test="${!(r.ZONE_CODE == '-')}">
                            ...
                            <th align="left" width="26%" height="22px">
								<a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_11_COMM/ALL/${r.ZONE_CODE}/ALL INDIA/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
