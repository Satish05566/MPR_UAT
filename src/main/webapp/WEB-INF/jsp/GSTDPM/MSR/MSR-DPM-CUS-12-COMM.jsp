...
<head>
  ...
  <script src="<%= session.getAttribute("JSP_PATH_RESOLVE") %>/Content-MPR/jsMPR/jquery-3.6.0.min.js"></script>
    ...
    <title>MSR-DPM-CUS-12-COMM</title>
</head>
<body>
    <div id="Report_main">
       ...
       <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_12/All/0/All%20India/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>                
        <c:if test="${empty Model}">
            <table class="Report_body">
                <tr>
