    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=rdOrder]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CUS_12/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_CUS_12/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio1 + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
...
<body>
    ...
    <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM_CUS-12(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center">
                    ...
                    <h1>MSR-DPM-CUS-12</h1>

                    <h2> Monitoring of fulfillment of Export obligation- Report for AA/DFIA (from year 1991-92) as on end of the month</h2>
 ...
 <tr class="grid_head">
                       ...
                       <c:if test="${!(r.SNO != 100)}">
                        ...
                        <c:if test="${!(r.ZONE_CODE == '-')}">
                        
                            <th align="left" width="26%" height="22px">
								<a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_12_COMM/ALL/${r.ZONE_CODE}/ALL INDIA/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
