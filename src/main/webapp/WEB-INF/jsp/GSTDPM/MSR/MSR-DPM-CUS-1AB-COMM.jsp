...
<script type="text/javascript">
    ...
    <title>MSR-DPM-CUS-1AB-COMM</title>
</head>
<body>
     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; int rowNO=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <a download='MSR-DPM-CUS-1AB(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:set var = "above_1"  value = "${above_1 + r.COMM_MORE_YEAR_AMT_FOR}"/>
   ...
   <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_1AB/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
      </c:if>
