        ...
        <c:if test="${!(empty Model)}">
            ...
            <tr>
                ...
                <td colspan="3" align="center">
                    ...
                    <h2> ADJUDICATION  CASES IN ${display}  ORDER  ON THE BASIS OF CLOSING BALANCE IN AMOUNT</h2>
                </td>
                ...
                <c:set var = "total"  value = "${r.TOTAL}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <th align="left" width="4%" height="22px">
                            <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_1AE_COMM/ALL/${r.ZONE_CODE}/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                                                </th>
