...
<c:if test="${total_oio_upto != 0}">
          <c:set var = "per_30"  value = "${(no_30_upto / total_oio_upto) * 100}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <td align="right" width="4%" height="22px">
                            <c:if test="${r.TOTAL_PERCENT_FOR == '-999.00'}">
                            	-
                                </c:if>
                        ...
                        <td align="right" width="4%" height="22px">
                            ...
                            <c:if test="${r.TOTAL_PERCENT_UPTO == '-999.00'}">
                            	-
                                </c:if>
               				<c:if test="${!(r.TOTAL_PERCENT_UPTO == '-999.00')}">
             ...
             <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_1C/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
