...
<body>
 ...
 <c:set var = "more_1"  value = "${more_1 + r.MORE_THAN_1}"/>
            ...
            <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_2A/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
