...
<body>
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <a download='MSR-DPM-CUS-3A(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center" style="font-size:18px;">
                    ...
                    <h2> CALL BOOK CASES IN ${display} ORDER ON THE BASIS OF CLOSING BALANCE</h2>
                </td>
       ...
       <c:if test="${!(empty Model)}">
            ...
            <table class="Report_body">
                ...
                <tr>
                    ...
                    <th align="center" colspan="5" width="50">
 ...
 <c:set var = "closing_no"  value = "${closing_no + r.CLOSING}"/>
 <c:set var = "amount"  value = "${amount + r.AMOUNT}"/>
 <c:set var = "less_3"  value = "${less_3 + r.MONTHS_3}"/>
 <c:set var = "less_6"  value = "${less_6 + r.MONTHS_3TO6}"/>
 <c:set var = "less_12"  value = "${less_12 + r.MONTHS_6TO12}"/>
 <c:set var = "less_1"  value = "${less_1 + r.YEARS_1TO2}"/>
 <c:set var = "above_2"  value = "${above_2 + r.MORE_2YEAR}"/>
                  ...
                  <tr>
                        ...
                        <th align="left" width="25%" height="22px">
                            <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_3A_COMM/ALL/${r.ZONE_CODE}/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
