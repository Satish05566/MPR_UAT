    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <a download='MSR-DPM-CUS-3BA(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center" style="font-size:18px;">
                    ...
                    <% String display = ""; %>
                     ...
                     <h1>MSR-DPM-CUS-3BA</h1>

                    <h2> CALL BOOK CASES <label id="lbl_order">DESCENDING</label> IN ORDER  ON THE BASIS OF NO.OF CASES PENDING.<br/>
                    CATEGORY:CASES IN WHICH DEPARTMENT HAS GONE IN APPEAL TO THE APPROPRIATE AUTHORITY</h2>
                </td>
       ...
       <c:if test="${!(empty Model)}">
            ...
            <table class="Report_body">
             ...
             <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_3BB/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
