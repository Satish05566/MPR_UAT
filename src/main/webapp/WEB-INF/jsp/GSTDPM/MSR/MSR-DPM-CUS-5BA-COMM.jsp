    ...
    <div id="Report_main">
       ...
       <c:if test="${!(empty Model)}">
            ...
            <table class="Report_body">
              ...
              <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_5BA/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
