    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <a download='MSR-DPM-CUS-5BB(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
                ...
                <c:forEach var ="r" items="${Model}" >
                 ...
                 <c:if test="${r.SNO != 50}">
                       ...
                       <c:if test="${!(r.ZONE_CODE!='ZY')}">
                        ...
                        <td align="right" width="12%" height="22px">
                            ${r.DOCUMENTS_MONTHS_0TO6_NO}
                        </td>
                        <td align="right" width="12%" height="22px">
                            ${r.DOCUMENTS_MONTHS_6TO12_NO}
                        </td>
                        <td align="right" width="12%" height="22px">
                            ${r.DOCUMENTS_YEAR_1TO2_NO}
                        </td>

                        <td align="right" width="12%" height="22px">
                            ${r.DOCUMENTS_MORE_2YEAR_NO}
                        </td>
