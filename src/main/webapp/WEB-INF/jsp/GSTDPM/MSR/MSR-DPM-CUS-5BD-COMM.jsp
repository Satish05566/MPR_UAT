    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <a download='MSR-DPM-CUS-5BD(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center" style="font-size:18px;">
                    ...
                    <% String display = ""; %>
                         ...
                         <h1>MSR-DPM-CUS-5BD</h1>

                    <h2> Provisional Assessment Cases- Project Import (Waiting for End Use) in <label id="lbl_order">descending</label> order on the basis of Closing Balance</h2>
                            </td>
       ...
       <c:if test="${!(empty Model)}">
            ...
            <table class="Report_body">
               ...
               <c:forEach var ="r" items="${Model}" >
                 ...
                 <c:if test="${r.SNO != 50}">
                        ...
                        <td align="right" width="12%" height="22px">
                            ${r.PROJECT_MONTHS_0TO6_NO}
                        </td>
                        <td align="right" width="12%" height="22px">
                            ${r.PROJECT_MONTHS_6TO12_NO}
                        </td>
                        <td align="right" width="12%" height="22px">
                            ${r.PROJECT_YEAR_1TO2_NO}
                        </td>

                        <td align="right" width="12%" height="22px">
                            ${r.PROJECT_MORE_2YEAR_NO}
                        </td>
            ...
            <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_5BD/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
