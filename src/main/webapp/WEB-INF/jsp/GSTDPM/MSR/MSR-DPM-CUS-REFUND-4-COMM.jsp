...
<body>
    ...
    <div id="Report_main">
       ...
       <c:if test="${!(empty Model)}">
            ...
            <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_CUS_REFUND_4/All/0/DESC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
