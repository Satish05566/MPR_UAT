     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; int rowNO=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <td style="text-align: left;">
                        ...
                        <c:if test = "${AMND != 0}">
                            <a href="../../../../../Home/CorrectionBackup?MM_YYYY=${ViewBag_MM_YYYY}.MM_YYYY&MPR=DPM-ST-1AD" style="color:brown; font-weight:bold;"><img src="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>Content-MPR/imagesMPR/mpr-img/Amended.gif" /></a>
                        </c:if>
                    </td>
                    <%
            ...
            <tr>
                ...
                <td colspan="3" align="center">
                   ...
                   <% String display = ""; %>
                    ...
                    <h2> ADJUDICATING AUTHORITY:DC/AC</h2>
                </td>
...
<c:set var = "opening_no"  value = "${opening_no + r.AC_OPENING_NO}"/>
<c:set var = "receipts_for"  value = "${receipts_for + r.AC_RECEIPT_NO_FOR}"/>
<c:set var = "receipts_upto"  value = "${receipts_upto + r.AC_RECEIPT_NO_UPTO}"/>
<c:set var = "disposal_for"  value = "${disposal_for + r.AC_DISPOSAL_NO_FOR}"/>
<c:set var = "disposal_upto"  value = "${disposal_upto + r.AC_DISPOSAL_NO_UPTO}"/>
<c:set var = "closing_no"  value = "${closing_no + r.AC_CLOSING_NO}"/>
<c:set var = "less_3"  value = "${less_3 + r.AC_MONTHS_3_AMT_FOR}"/>

<c:set var = "less_6"  value = "${less_6 + r.AC_MONTHS_3TO6_AMT_FOR}"/>
<c:set var = "less_12"  value = "${less_12 + r.AC_MONTHS_6TO12_AMT_FOR}"/>
<c:set var = "above_1"  value = "${above_1 + r.AC_MORE_YEAR_AMT_FOR}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <td align="right" width="7%" height="22px">
                            ${r.AC_RECEIPT_NO_UPTO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.AC_DISPOSAL_NO_FOR}
                        </td>

                        <td align="right" width="7%" height="22px">
                            ${r.AC_DISPOSAL_NO_UPTO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.AC_CLOSING_NO}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.AC_MONTHS_3_AMT_FOR}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.AC_MONTHS_3TO6_AMT_FOR}
                        </td>

                        <td align="right" width="7%" height="22px">
                            ${r.AC_MONTHS_6TO12_AMT_FOR}
                        </td>
                        <td align="right" width="7%" height="22px">
                            ${r.AC_MORE_YEAR_AMT_FOR}
                        </td>
...
<a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_ST_1AD/All/0/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
         </c:if>
