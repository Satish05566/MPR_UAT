     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; int rowNO=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-ST-1C(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
...
<c:if test="${total_oio_upto != 0}">
          <c:set var = "per_30"  value = "${(no_30_upto / total_oio_upto) * 100}"/>
                    ...
                    <tr class="grid_head">
                        ...
                        <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_ST_1C_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                        </th>
