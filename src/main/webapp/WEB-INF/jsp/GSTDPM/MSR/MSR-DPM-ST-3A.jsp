     ...
     <%!  String desDt = ""; String desDt1 = ""; int month=0; int year=0; int rowNO=0; %>
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-ST-3A(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
                ...
                <c:forEach var ="r" items="${Model}" >
                    ...
                    <tr>
                        ...
                        <th align="left" width="25%" height="22px">
                            <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_ST_3A_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                        </th>
