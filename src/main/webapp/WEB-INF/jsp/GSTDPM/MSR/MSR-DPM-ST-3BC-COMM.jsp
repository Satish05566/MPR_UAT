  ...
  <script src="<%= session.getAttribute("JSP_PATH_RESOLVE") %>/Content-MPR/jsMPR/Sort.js"></script>
    ...
    $(function () {
        $('input[name=rdOrder]').click(function () {
            ...
            window.location = "/MIS/DPM/MSR/MSR_DPM_ST_3BC_COMM/" + checked_site_radio + "/@ViewContext.RouteData.Values["Code"]/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_ST_3BC_COMM/" + checked_site_radio1 + "/@ViewContext.RouteData.Values["Code"]/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
...
<body>
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
         ...
         <a id="back_lnk" href="<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_ST_3BC/All/0/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>">Back to Previous Report</a>
