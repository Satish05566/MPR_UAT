    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=rdOrder]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_ST_5A/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
        ...
        $(function () {
            $('input[name=rdOrder1]').click(function () {
                ...
                window.location = "/MIS/DPM/MSR/MSR_DPM_ST_5A/@ViewContext.RouteData.Values["Report_Type"]/" + checked_site_radio1 + "/All%20India/@ViewContext.RouteData.Values["MM_YYYY"]";
    ...
    <div id="Report_main">
        ...
        <c:if test="${!(empty Model)}">
                    ...
                    <%
                        ...
                        <a download='MSR-DPM-ST-5(<%= desDt.toUpperCase() %>).xls' href="#">Download</a>
            ...
            <tr>
                ...
                <td colspan="3" align="center">
                    ...
                    <h2> Pendency of Provisional Assessment cases in <label id="lbl_order">descending</label> order on the basis of Closing Balance.</h2>
        ...
        <c:if test="${!(empty Model)}">
            <table class="Report_body">
                <tr>
                    ...
                    <th align="center" rowspan="2" width="16%">
                        CLOSING BALANCE
                    </th>
                    <th align="center" colspan="4" width="48%">
                        BREAKUP OF PENDENCY
                    </th>
                </tr>
                <tr>
                    ...
                    <tr class="grid_head">
                        ...
                        <c:if test="${r.ZONE_CODE!='ZY'}">                       
                            <th align="left" width="25%" height="22px">
                                <a id="Zone_Link" href= "<%= session.getAttribute("DYNAMIC_LINK_PATH") %>GSTDPM/MSR/MSR_DPM_ST_5A_COMM/ALL/${r.ZONE_CODE}/DSC/<%= desDt1.toUpperCase() %>/<%= session.getAttribute("CSRF_Token") %>" >${r.ZONE_NAME}</a>
                       ...
                       <c:if test="${r.ZONE_CODE=='ZY'}">      
                        ...
                        <td align="right" width="16%" height="22px">
                            ${r.CLOSING_NO}
                        </td>
