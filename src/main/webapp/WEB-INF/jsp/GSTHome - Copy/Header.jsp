                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                           ...
                           <% } %>
                            ...
                            <%if((type.toString()=="ZONE"))	
                             {%>
                         	<li>
                                <a class="eng" target="_blank" href='<%= session.getAttribute("DYNAMIC_LINK_PATH") %>UPLOAD/User_Manual_zone.pdf'><i class="fa fa-book fa-fw"></i> User Manual</a>
                                
                            </li>
                           <% }%>
                           
                           <%if((type.toString()=="COMMISSIONERATE"))	
                            {%>
                                  
                         	<li>
                                <a class="eng" target="_blank" href='<%= session.getAttribute("DYNAMIC_LINK_PATH") %>UPLOAD/User_Manual_comm.pdf'><i class="fa fa-book fa-fw"></i> User Manual</a>
