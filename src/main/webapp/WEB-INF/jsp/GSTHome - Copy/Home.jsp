			...
			<div class="panel panel-primary">
				...
				<a href="#">
					<div class="panel-footer">
						<span class="pull-left"> <a	class="btn btn-primary float-right" href='<%=request.getSession().getAttribute("DYNAMIC_LINK_PATH") %>GSTHome/Report/<%=request.getSession().getAttribute("CSRF_Token").toString() %>'> 
				...
				<a href="#">
					<div class="panel-footer">
						<span class="pull-left"> 
                            <a class="btn btn-primary float-right" href='<%=request.getSession().getAttribute("DYNAMIC_LINK_PATH") %>GSTHome/MSR/<%=request.getSession().getAttribute("CSRF_Token").toString() %>'>
