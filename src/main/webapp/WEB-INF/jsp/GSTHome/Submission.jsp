...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-check fa-fw" id="Heading_View"></i> 
  ...
  /*  function chkReportBind(def) {
    ...
    function DisplayReport(group, data, divNo) {
        if (data != '[]' && data != '') {
            ...
            for (var x = 0; x < arr.length; x++) {
                ...
                if (arr[x].CODE == 'DDM-GST-1' || arr[x].CODE == 'DDM-GST-2' || arr[x].CODE == 'DDM-GST-5' || arr[x].CODE == 'DPM-GST-4' || arr[x].CODE == 'DPM-GST-12' || arr[x].CODE == 'DPM-GST-14' || arr[x].CODE == 'DPM-GST-15' || arr[x].CODE == 'DPM-GST-ADJ-1' || arr[x].CODE == 'DPM-GST-ADJ-2' || arr[x].CODE == 'DPM-GST-ADJ-3') 
                {
                ...
                else if (arr[x].CODE == 'DDM-GST-3' || arr[x].CODE == 'DDM-GST-3A' || arr[x].CODE == 'DDM-GST-4' || arr[x].CODE == 'DDM-GST-4A' || arr[x].CODE == 'GST-GST-2') 
                {
                	...
                	markup += "<a class='btn btn-default' style='margin:10px; background-color: #f2dede;' title='This proforma contains data pertaining to Section 39 of the CGST Act, 2017 and is available for the month prior to the reporting month' href='javascript: GetReport(" + '"' + arr[x].CODE + '"' + ");'>" + arr[x].CODE + "</a>"
				}
   ...
   //----------------------------------------------------------
    function GetReport(reportname) {
       ...
       var MM_YYYY='-';
       var Submission_Date='';
       if (reportname.substring(0, 2)== 'GI') {
        window.open("<%=request.getSession().getAttribute("DYNAMIC_LINK_PATH") %>GST" + reportname.substring(0, 2) + "/Report/" + reportname.replace(/\-/g, '_') + "/Temp/" + code + "/" + name + "/" + "-/"+"/<%=request.getSession().getAttribute("CSRF_Token").toString() %>" , '_blank');
       }
       else
       {
