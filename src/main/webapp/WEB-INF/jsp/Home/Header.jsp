        ...
        <nav class="navbar navbar-default navbar-static-top pos-fixed" role="navigation" style="margin-bottom: 0; width:100%" id="navigation_desk">
            ...
            <!-- /.navbar-header -->
                ...
                if ((String)request.getSession().getAttribute("USER")!="ddmC1_cbec")
                    { %>
                        <li class="dropdown">
                            <a href="<%=request.getSession().getAttribute("DYNAMIC_LINK_PATH") %>GSTHome/Left_Menu_Home/<%=request.getSession().getAttribute("CSRF_Token").toString() %>" class="btn btn-primary eng">
                                <i class="fa fa-sign-out fa-fw"></i> POST-GST
                            </a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                                  ...
                                  <li>                       
                                <a class="eng" href="<%=request.getSession().getAttribute("DYNAMIC_LINK_PATH") %>Home/Home/<%=request.getSession().getAttribute("CSRF_Token").toString() %>"><i class="fa fa-home fa-fw"></i> Management Information</a>
...
<!--                                     <a class="eng" href='/Insert'><i class="fa fa-upload fa-fw"></i> Upload</a> -->
...
<!--                                     <a class="eng" href='/Validate/Submission'><i class="fa fa-check fa-fw"></i> Validate</a> -->
...
<!--                                     <a class="eng" href='/ZoneCorrection'><i class="fa fa-edit fa-fw"></i> Correction</a> -->
<!--                                 </li> -->
                           <% }
                            ...
                            { %>
<!--                                 <li> -->
<!--                                    <a class="eng" href='/FO_Correction'><i class="fa fa-edit fa-fw"></i> Correction</a> -->
...
<!--                                 </li> -->
                           ...
                           String Type = (String)request.getSession().getAttribute("TYPE");
                            ...
                            else if((request.getSession().getAttribute("TYPE")!=null && request.getSession().getAttribute("TYPE")!="") && ((String)request.getSession().getAttribute("TYPE").toString().substring(0, 2)=="CBEC"))
                            { %>
<!--                                 <li> -->
...
<!--                                 <a class="eng" href='#'><i class="fa fa-th-large fa-fw"></i> Status</a> -->
<!--                             </li> -->
