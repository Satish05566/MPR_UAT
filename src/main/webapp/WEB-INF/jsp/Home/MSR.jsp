       ...
       <div class="col-lg-6">
		...
		<div class="col-lg-6">
			...
			<ol class="breadcrumb float-right no-bg-col p-t-20 m-b-0 p-r-0">
				<li><a href="/MSR"><i class="fa fa-home"></i> Management Information</a></li>
...
<!--                                         } -->
                                ...
                                <div class="col-lg-4" id="MSR_Year_From">
                                    <div class="form-group">
                                    <select class="form-control" id="ddl_year_from" name="ddl_year_from">
...
<!--                                         } -->
                                ...
                                <div class="col-lg-4" id="MSR_Year_To" style="display: block; float: left">
                                  ...
                                  <select class="form-control" id="ddl_year_to" name="ddl_year_to"><option value="2016">2016-2017</option>
<option value="2015">2015-2016</option>
</select>
...
<script language="javascript" type="text/javascript">
    ...
    function GetReport_DPM(reportname) {
        ...
        var url = "/" + reportname.substring(4, 7) + "/MSR/" + reportname.replace(/\-/g, '_') + "/All/0/DSC/" + $('#ddl_year').val() + "-" + $("#ddl_mth option:selected").text();
    ...
    jQuery('#ddl_year').change(function (data) {
        ...
        $('#ddl_mth').html(data);
        $('#ddl_mth_to').html(data);

    });


    $('#ddl_year_from').change(function () {
        var currentSelectedYear = $(this).val();
        $('#ddl_year_to').empty();        
        if (currentSelectedYear != '') {

            var SelectedYear = parseInt(currentSelectedYear);
            for (var month = 0; month <= 3; month++) {
                var getYear=parseInt(2014 + month);
                if (getYear >= parseInt(SelectedYear)) {
                    $('#ddl_year_to').append('<option value="' + (getYear) + '">' +(getYear-1+"-"+ getYear) + '</option>');
                }
            }
        }
            ...
            for (var month = 0; month <= totalMonths; month++) {
                ...
                if (parseInt(month + 1) >= parseInt(SelectedMonth)) {
                    if (currentSelectedYear == '2017') {
                        if (parseInt(month + 1) == 4 || parseInt(month + 1) == 5 || parseInt(month + 1) == 6) {
